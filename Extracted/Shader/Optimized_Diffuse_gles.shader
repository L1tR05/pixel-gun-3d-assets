...
void main ()
{
  ...
  highp vec2 tmpvar_6;
  tmpvar_6 = fract(xlv_TEXCOORD0);
  tmpvar_2 = texture2D (_MainTex, tmpvar_6).xyz;
  c_1.w = 0.0;
  ...
  tmpvar_11 = max (0.05, dot (tmpvar_3, lightDir_8));
  diff_10 = tmpvar_11;
  c_9.xyz = ((tmpvar_2 * _LightColor0.xyz) * (diff_10 * 1.2));
  c_9.w = 1.0;
  tmpvar_7 = c_9;
...
void main ()
{
  ...
  highp vec2 tmpvar_7;
  tmpvar_7 = fract(xlv_TEXCOORD0);
  tmpvar_3 = texture2D (_MainTex, tmpvar_7).xyz;
  ...
  tmpvar_15 = max (0.05, dot (tmpvar_4, lightDir_11));
  diff_14 = tmpvar_15;
  c_13.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((diff_14 * atten_12) * 1.2));
  c_13.w = 1.0;
  tmpvar_10 = c_13;
  c_1.xyz = (c_1 + tmpvar_10).xyz;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lm_1 = tmpvar_6;
  c_3.xyz = (texture2D (_MainTex, tmpvar_4).xyz * lm_1);
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  tmpvar_25 = max (0.05, dot (tmpvar_3, lightDir_21));
  diff_24 = tmpvar_25;
  c_23.xyz = ((tmpvar_7.xyz * _LightColor0.xyz) * ((diff_24 * atten_22) * 1.2));
  c_23.w = 1.0;
  tmpvar_20 = c_23;
  c_1.xyz = (c_1 + tmpvar_20).xyz;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  highp vec3 lightDir_23;
  lightDir_23 = lightDir_4;
  highp float atten_24;
  atten_24 = atten_2;
  lowp vec4 c_25;
  lowp float diff_26;
  highp float tmpvar_27;
  tmpvar_27 = max (0.05, dot (tmpvar_3, lightDir_23));
  diff_26 = tmpvar_27;
  c_25.xyz = ((tmpvar_7.xyz * _LightColor0.xyz) * ((diff_26 * atten_24) * 1.2));
  c_25.w = 1.0;
  tmpvar_22 = c_25;
...
void main ()
{
  ...
  lm_1 = tmpvar_10;
  c_3.xyz = (texture2D (_MainTex, tmpvar_4).xyz * min (lm_1, vec3((tmpvar_5 * 2.0))));
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  highp vec2 tmpvar_4;
  tmpvar_4 = fract(xlv_TEXCOORD0);
  tmpvar_3 = texture2D (_MainTex, tmpvar_4).xyz;
  tmpvar_2 = tmpvar_3;
  mediump vec4 res_5;
