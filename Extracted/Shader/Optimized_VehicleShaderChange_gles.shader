...
//
///////////////////////////////////////////
Shader "Optimized/VehicleShaderChange" {
Properties {
_MainTex ("Base (RGB)", 2D) = "white" { }
_Detail ("Detail (RGBA)", 2D) = "alpha" { }
_Power ("DetailPower", Range(0, 1)) = 0.1
_Color ("ColorChange", Color) = (0,0,0,0)
...
void main ()
{
  ...
  c_7.w = tmpvar_8.w;
  c_7.xyz = (tmpvar_8.xyz + ((_CarColor * tmpvar_8.w).xyz * tmpvar_8.xyz));
  highp float tmpvar_9;
  tmpvar_9 = float((_Power == 1.0));
  p_6 = tmpvar_9;
  highp vec3 tmpvar_10;
  lowp vec3 y_11;
  y_11 = (c_7.xyz * texture2D (_Detail, xlv_TEXCOORD0).xyz);
  tmpvar_10 = mix (c_7.xyz, y_11, vec3(_Power));
  tmpvar_5 = (tmpvar_10 - (p_6 * 0.4));
  c_1.w = 0.0;
  c_1.xyz = (tmpvar_5 * xlv_TEXCOORD3);
  highp vec4 tmpvar_12;
  highp vec3 lightDir_13;
  lightDir_13 = lightDir_3;
  lowp vec4 c_14;
  lowp float diff_15;
  highp float tmpvar_16;
  tmpvar_16 = max (0.0, dot (tmpvar_2, lightDir_13));
  diff_15 = tmpvar_16;
  c_14.xyz = (((tmpvar_5 * _LightColor0.xyz) * (diff_15 * 1.2)) + _Color.xyz);
  tmpvar_12 = c_14;
...
void main ()
{
  ...
  highp vec3 lightDir_16;
  lightDir_16 = lightDir_4;
  highp float atten_17;
  atten_17 = atten_2;
  lowp vec4 c_18;
  lowp float diff_19;
  highp float tmpvar_20;
  tmpvar_20 = max (0.0, dot (tmpvar_3, lightDir_16));
  diff_19 = tmpvar_20;
  c_18.xyz = (((tmpvar_6 * _LightColor0.xyz) * (
    (diff_19 * atten_17)
   * 1.2)) + _Color.xyz);
  tmpvar_15 = c_18;
  c_1.xyz = (c_1 + tmpvar_15).xyz;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  highp vec3 lightDir_26;
  lightDir_26 = lightDir_4;
  highp float atten_27;
  atten_27 = atten_2;
  lowp vec4 c_28;
  lowp float diff_29;
  highp float tmpvar_30;
  tmpvar_30 = max (0.0, dot (tmpvar_3, lightDir_26));
  diff_29 = tmpvar_30;
  c_28.xyz = (((tmpvar_6 * _LightColor0.xyz) * (
    (diff_29 * atten_27)
   * 1.2)) + _Color.xyz);
  tmpvar_25 = c_28;
  c_1.xyz = (c_1 + tmpvar_25).xyz;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_17 = tmpvar_18;
  lowp float tmpvar_19;
  tmpvar_19 = clamp (dot (texture2D (unity_ShadowMask, xlv_TEXCOORD4), unity_OcclusionMaskSelector), 0.0, 1.0);
  ...
  tmpvar_32 = max (0.0, dot (tmpvar_3, lightDir_28));
  diff_31 = tmpvar_32;
  c_30.xyz = (((tmpvar_6 * _LightColor0.xyz) * (
    (diff_31 * atten_29)
   * 1.2)) + _Color.xyz);
  tmpvar_27 = c_30;
  c_1.xyz = (c_1 + tmpvar_27).xyz;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_16 = (unity_Lightmap_HDR.x * lmtex_2.xyz);
  lm_1 = tmpvar_16;
  c_3.xyz = (tmpvar_4 * min (lm_1, vec3((tmpvar_11 * 2.0))));
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  c_1.xyz = mix (unity_FogColor.xyz, c_1.xyz, vec3(tmpvar_21));
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
