...
void main()
{
    ...
    u_xlat10_2.xyz = texture(_GlossTex, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1.xyz = u_xlat0.xyz * u_xlat10_2.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(2.0, 2.0, 2.0) + u_xlat0.xyz;
    ...
    u_xlat0.xyz = vec3(u_xlat2) * u_xlat16_3.xyz;
    u_xlat16_1.w = 0.0;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat2.xxx * u_xlat16_3.xyz;
    u_xlat16_1.w = 0.0;
    u_xlat0 = u_xlat0 + u_xlat16_1;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_3.xyz + (-unity_FogColor.xyz);
    u_xlat14 = vs_TEXCOORD4;
#ifdef UNITY_ADRENO_ES3
    u_xlat14 = min(max(u_xlat14, 0.0), 1.0);
#else
