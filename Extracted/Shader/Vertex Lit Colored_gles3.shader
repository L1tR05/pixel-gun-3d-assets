...
void main()
{
    ...
    if(u_xlatb34){
...
#endif
#ifdef UNITY_ADRENO_ES3
        u_xlatb5 = !!(unity_LightAtten[0].w<u_xlat34);
#else
        u_xlatb5 = unity_LightAtten[0].w<u_xlat34;
#endif
        u_xlatb37 = u_xlatb37 && u_xlatb5;
        u_xlat16_18.x = (u_xlatb37) ? 0.0 : u_xlat35;
        u_xlat34 = max(u_xlat34, 9.99999997e-07);
        u_xlat34 = inversesqrt(u_xlat34);
        u_xlat5.xyz = vec3(u_xlat34) * u_xlat4.xyz;
        u_xlat35 = dot(u_xlat5.xyz, unity_SpotDirection[0].xyz);
        ...
        u_xlatb35 = 0.0<u_xlat16_29;
#endif
        u_xlat16_9.xyz = u_xlat4.xyz * vec3(u_xlat34) + (-u_xlat2.xyz);
        u_xlat16_29 = dot(u_xlat16_9.xyz, u_xlat16_9.xyz);
        u_xlat16_29 = inversesqrt(u_xlat16_29);
        u_xlat16_9.xyz = vec3(u_xlat16_29) * u_xlat16_9.xyz;
        u_xlat16_29 = dot(u_xlat1.xyz, u_xlat16_9.xyz);
    ...
    if(u_xlatb35){
        ...
        u_xlat5.x = unity_LightAtten[1].z * u_xlat37 + 1.0;
        u_xlat5.x = float(1.0) / u_xlat5.x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb16 = !!(unity_LightPosition[1].w!=0.0);
#else
        u_xlatb16 = unity_LightPosition[1].w!=0.0;
#endif
#ifdef UNITY_ADRENO_ES3
        u_xlatb27 = !!(unity_LightAtten[1].w<u_xlat37);
#else
        u_xlatb27 = unity_LightAtten[1].w<u_xlat37;
#endif
        u_xlatb16 = u_xlatb27 && u_xlatb16;
        u_xlat16_18.x = (u_xlatb16) ? 0.0 : u_xlat5.x;
        ...
        u_xlat16_29 = u_xlat38 + (-unity_LightAtten[1].x);
        u_xlat16_29 = u_xlat16_29 * unity_LightAtten[1].y;
#ifdef UNITY_ADRENO_ES3
        u_xlat16_29 = min(max(u_xlat16_29, 0.0), 1.0);
#else
        ...
        u_xlat16_8.xyz = u_xlat16_8.xyz * unity_LightColor[1].xyz;
#ifdef UNITY_ADRENO_ES3
        u_xlatb5 = !!(0.0<u_xlat16_29);
#else
        u_xlatb5 = 0.0<u_xlat16_29;
#endif
        u_xlat16_10.xyz = u_xlat4.xyz * vec3(u_xlat37) + (-u_xlat2.xyz);
        u_xlat16_29 = dot(u_xlat16_10.xyz, u_xlat16_10.xyz);
        u_xlat16_29 = inversesqrt(u_xlat16_29);
        u_xlat16_10.xyz = vec3(u_xlat16_29) * u_xlat16_10.xyz;
        u_xlat16_29 = dot(u_xlat1.xyz, u_xlat16_10.xyz);
        ...
        u_xlat16_29 = u_xlat16_29 * u_xlat16_18.x;
        u_xlat16_10.xyz = vec3(u_xlat16_29) * unity_LightColor[1].xyz + u_xlat16_9.xyz;
        u_xlat16_9.xyz = (bool(u_xlatb5)) ? u_xlat16_10.xyz : u_xlat16_9.xyz;
        u_xlat16_18.xyz = u_xlat16_18.xxx * u_xlat16_8.xyz;
        u_xlat16_18.xyz = min(u_xlat16_18.xyz, vec3(1.0, 1.0, 1.0));
        u_xlat16_3.xyz = u_xlat16_3.xyz + u_xlat16_18.xyz;
        u_xlati34 = 2;
...
#ifdef UNITY_ADRENO_ES3
    u_xlatb4 = !!(u_xlati34<unity_VertexLightParams.x);
#else
    u_xlatb4 = u_xlati34<unity_VertexLightParams.x;
#endif
    u_xlatb35 = u_xlatb35 && u_xlatb4;
    if(u_xlatb35){
        u_xlat4.xyz = (-u_xlat0.xyz) * unity_LightPosition[2].www + unity_LightPosition[2].xyz;
        u_xlat37 = dot(u_xlat4.xyz, u_xlat4.xyz);
        u_xlat5.x = unity_LightAtten[2].z * u_xlat37 + 1.0;
        u_xlat5.x = float(1.0) / u_xlat5.x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb16 = !!(unity_LightPosition[2].w!=0.0);
#else
        u_xlatb16 = unity_LightPosition[2].w!=0.0;
#endif
#ifdef UNITY_ADRENO_ES3
        u_xlatb27 = !!(unity_LightAtten[2].w<u_xlat37);
#else
        u_xlatb27 = unity_LightAtten[2].w<u_xlat37;
#endif
        u_xlatb16 = u_xlatb27 && u_xlatb16;
        ...
        u_xlat38 = max(u_xlat38, 0.0);
        u_xlat16_29 = u_xlat38 + (-unity_LightAtten[2].x);
        u_xlat16_29 = u_xlat16_29 * unity_LightAtten[2].y;
#ifdef UNITY_ADRENO_ES3
        u_xlat16_29 = min(max(u_xlat16_29, 0.0), 1.0);
#else
    ...
    if(u_xlatb35){
        u_xlat4.xyz = (-u_xlat0.xyz) * unity_LightPosition[3].www + unity_LightPosition[3].xyz;
        u_xlat37 = dot(u_xlat4.xyz, u_xlat4.xyz);
        u_xlat5.x = unity_LightAtten[3].z * u_xlat37 + 1.0;
        u_xlat5.x = float(1.0) / u_xlat5.x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb16 = !!(unity_LightPosition[3].w!=0.0);
#else
        u_xlatb16 = unity_LightPosition[3].w!=0.0;
#endif
#ifdef UNITY_ADRENO_ES3
        u_xlatb27 = !!(unity_LightAtten[3].w<u_xlat37);
#else
        u_xlatb27 = unity_LightAtten[3].w<u_xlat37;
#endif
        u_xlatb16 = u_xlatb27 && u_xlatb16;
        ...
        u_xlat38 = max(u_xlat38, 0.0);
        u_xlat16_29 = u_xlat38 + (-unity_LightAtten[3].x);
        u_xlat16_29 = u_xlat16_29 * unity_LightAtten[3].y;
#ifdef UNITY_ADRENO_ES3
        u_xlat16_29 = min(max(u_xlat16_29, 0.0), 1.0);
#else
    ...
    if(u_xlatb35){
        u_xlat4.xyz = (-u_xlat0.xyz) * unity_LightPosition[4].www + unity_LightPosition[4].xyz;
        u_xlat37 = dot(u_xlat4.xyz, u_xlat4.xyz);
        u_xlat5.x = unity_LightAtten[4].z * u_xlat37 + 1.0;
        u_xlat5.x = float(1.0) / u_xlat5.x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb16 = !!(unity_LightPosition[4].w!=0.0);
#else
        u_xlatb16 = unity_LightPosition[4].w!=0.0;
#endif
#ifdef UNITY_ADRENO_ES3
        u_xlatb27 = !!(unity_LightAtten[4].w<u_xlat37);
#else
        u_xlatb27 = unity_LightAtten[4].w<u_xlat37;
#endif
        u_xlatb16 = u_xlatb27 && u_xlatb16;
        ...
        u_xlat38 = max(u_xlat38, 0.0);
        u_xlat16_29 = u_xlat38 + (-unity_LightAtten[4].x);
        u_xlat16_29 = u_xlat16_29 * unity_LightAtten[4].y;
#ifdef UNITY_ADRENO_ES3
        u_xlat16_29 = min(max(u_xlat16_29, 0.0), 1.0);
#else
    ...
    if(u_xlatb35){
        u_xlat4.xyz = (-u_xlat0.xyz) * unity_LightPosition[5].www + unity_LightPosition[5].xyz;
        u_xlat37 = dot(u_xlat4.xyz, u_xlat4.xyz);
        u_xlat5.x = unity_LightAtten[5].z * u_xlat37 + 1.0;
        u_xlat5.x = float(1.0) / u_xlat5.x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb16 = !!(unity_LightPosition[5].w!=0.0);
#else
        u_xlatb16 = unity_LightPosition[5].w!=0.0;
#endif
#ifdef UNITY_ADRENO_ES3
        u_xlatb27 = !!(unity_LightAtten[5].w<u_xlat37);
#else
        u_xlatb27 = unity_LightAtten[5].w<u_xlat37;
#endif
        u_xlatb16 = u_xlatb27 && u_xlatb16;
        ...
        u_xlat38 = max(u_xlat38, 0.0);
        u_xlat16_29 = u_xlat38 + (-unity_LightAtten[5].x);
        u_xlat16_29 = u_xlat16_29 * unity_LightAtten[5].y;
#ifdef UNITY_ADRENO_ES3
        u_xlat16_29 = min(max(u_xlat16_29, 0.0), 1.0);
#else
    ...
    if(u_xlatb35){
        u_xlat4.xyz = (-u_xlat0.xyz) * unity_LightPosition[6].www + unity_LightPosition[6].xyz;
        u_xlat37 = dot(u_xlat4.xyz, u_xlat4.xyz);
        u_xlat5.x = unity_LightAtten[6].z * u_xlat37 + 1.0;
        u_xlat5.x = float(1.0) / u_xlat5.x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb16 = !!(unity_LightPosition[6].w!=0.0);
#else
...
#endif
#ifdef UNITY_ADRENO_ES3
        u_xlatb27 = !!(unity_LightAtten[6].w<u_xlat37);
#else
        u_xlatb27 = unity_LightAtten[6].w<u_xlat37;
#endif
        u_xlatb16 = u_xlatb27 && u_xlatb16;
        ...
        u_xlat38 = max(u_xlat38, 0.0);
        u_xlat16_29 = u_xlat38 + (-unity_LightAtten[6].x);
        u_xlat16_29 = u_xlat16_29 * unity_LightAtten[6].y;
#ifdef UNITY_ADRENO_ES3
        u_xlat16_29 = min(max(u_xlat16_29, 0.0), 1.0);
#else
    ...
    if(u_xlatb34){
        ...
        u_xlat35 = float(1.0) / u_xlat35;
#ifdef UNITY_ADRENO_ES3
        u_xlatb4 = !!(unity_LightPosition[7].w!=0.0);
#else
        u_xlatb4 = unity_LightPosition[7].w!=0.0;
#endif
#ifdef UNITY_ADRENO_ES3
        u_xlatb15 = !!(unity_LightAtten[7].w<u_xlat34);
#else
        u_xlatb15 = unity_LightAtten[7].w<u_xlat34;
#endif
        u_xlatb4 = u_xlatb15 && u_xlatb4;
        u_xlat16_18.x = (u_xlatb4) ? 0.0 : u_xlat35;
        u_xlat34 = max(u_xlat34, 9.99999997e-07);
        u_xlat34 = inversesqrt(u_xlat34);
        u_xlat4.xyz = u_xlat0.xyz * vec3(u_xlat34);
        u_xlat35 = dot(u_xlat4.xyz, unity_SpotDirection[7].xyz);
        u_xlat35 = max(u_xlat35, 0.0);
        u_xlat16_29 = u_xlat35 + (-unity_LightAtten[7].x);
        u_xlat16_29 = u_xlat16_29 * unity_LightAtten[7].y;
#ifdef UNITY_ADRENO_ES3
        u_xlat16_29 = min(max(u_xlat16_29, 0.0), 1.0);
#else
        ...
        u_xlat16_7.x = u_xlat16_7.x * u_xlat16_18.x;
        u_xlat16_7.xzw = u_xlat16_7.xxx * unity_LightColor[7].xyz + u_xlat16_9.xyz;
        u_xlat16_9.xyz = (bool(u_xlatb35)) ? u_xlat16_7.xzw : u_xlat16_9.xyz;
        u_xlat16_7.xyz = u_xlat16_18.xxx * u_xlat16_8.xyz;
        u_xlat16_7.xyz = min(u_xlat16_7.xyz, vec3(1.0, 1.0, 1.0));
        u_xlat16_3.xyz = u_xlat16_3.xyz + u_xlat16_7.xyz;
    //ENDIF
