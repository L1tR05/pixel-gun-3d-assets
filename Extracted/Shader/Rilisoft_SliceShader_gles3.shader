...
//
///////////////////////////////////////////
Shader "Rilisoft/SliceShader" {
Properties {
_MainTex ("Texture", 2D) = "white" { }
_ClipRange ("ClipRange", Vector) = (-1,-1,1,1)
}
SubShader {
...
void main()
{
    u_xlatb0.xy = lessThan(vs_TEXCOORD2.xyxx, _ClipRange.xyxx).xy;
    u_xlatb0.x = u_xlatb0.y || u_xlatb0.x;
    u_xlatb1.xy = lessThan(_ClipRange.zwzz, vs_TEXCOORD2.xyxx).xy;
    ...
    u_xlat16_0.xyz = u_xlat16_0.xyz * vs_TEXCOORD3.xyz + u_xlat16_0.xyz;
...
void main()
{
    u_xlatb0.xy = lessThan(vs_TEXCOORD2.xyxx, _ClipRange.xyxx).xy;
    u_xlatb0.x = u_xlatb0.y || u_xlatb0.x;
    u_xlatb3.xy = lessThan(_ClipRange.zwzz, vs_TEXCOORD2.xyxx).xy;
...
void main()
{
    u_xlatb0.xy = lessThan(vs_TEXCOORD1.xyxx, _ClipRange.xyxx).xy;
    u_xlatb0.x = u_xlatb0.y || u_xlatb0.x;
    u_xlatb1.xy = lessThan(_ClipRange.zwzz, vs_TEXCOORD1.xyxx).xy;
    u_xlatb0.x = u_xlatb1.x || u_xlatb0.x;
    u_xlatb0.x = u_xlatb1.y || u_xlatb0.x;
    if((int(u_xlatb0.x) * int(0xffffffffu))!=0){discard;}
    u_xlat10_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
