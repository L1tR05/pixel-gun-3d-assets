...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_5.xyz * u_xlat16_2.xxx + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_6.xyz * _LightColor0.xyz;
    u_xlat16_0.xyz = u_xlat16_3.xyz * u_xlat16_2.xxx + u_xlat16_0.xyz;
    SV_Target0.xyz = u_xlat16_6.xyz * vs_TEXCOORD3.xyz + u_xlat16_0.xyz;
    return;
}
...
void main()
{
    ...
    SV_Target0.w = u_xlat10_1.w * _Color.w;
    u_xlat16_3.xyz = u_xlat16_7.xyz * _LightColor0.xyz;
    u_xlat16_0.xyz = u_xlat16_3.xyz * u_xlat16_2.xxx + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_1.xyz * _LightColor0.xyz;
    u_xlat16_0.xyz = u_xlat16_5.xyz * u_xlat16_2.xxx + u_xlat16_0.xyz;
    u_xlat16_2.xyz = u_xlat16_1.xyz * vs_TEXCOORD3.xyz + u_xlat16_0.xyz;
    SV_Target0.w = u_xlat16_1.w;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_6.xyz * u_xlat16_2.xxx + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_2.xyz * vec3(u_xlat16_15) + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_0.xyz * u_xlat16_1.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_0.x = u_xlat16_0.x * u_xlat10_1.w;
    u_xlat16_1 = u_xlat10_1 * _Color;
    u_xlat4 = texture2D(_LightTexture0, vs_TEXCOORD3.xy).w;
    u_xlat16_2.xyz = vec3(u_xlat4) * _LightColor0.xyz;
    u_xlat16_3.xyz = u_xlat16_2.xyz * _SpecColor.xyz;
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz;
    SV_Target0.w = u_xlat16_1.w;
