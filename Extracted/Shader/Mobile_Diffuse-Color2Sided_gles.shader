...
void main ()
{
  ...
  tmpvar_15 = max (0.05, dot (tmpvar_3, lightDir_11));
  diff_14 = tmpvar_15;
  c_13.xyz = ((tmpvar_6.xyz * _LightColor0.xyz) * ((diff_14 * atten_12) * 1.2));
  c_13.w = tmpvar_6.w;
  tmpvar_10 = c_13;
  c_1 = (c_1 + tmpvar_10);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  diff_24 = tmpvar_25;
  c_23.xyz = ((tmpvar_6.xyz * _LightColor0.xyz) * ((diff_24 * atten_22) * 1.2));
  c_23.w = tmpvar_6.w;
  tmpvar_20 = c_23;
  c_1 = (c_1 + tmpvar_20);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  diff_26 = tmpvar_27;
  c_25.xyz = ((tmpvar_6.xyz * _LightColor0.xyz) * ((diff_26 * atten_24) * 1.2));
  c_25.w = tmpvar_6.w;
  tmpvar_22 = c_25;
  c_1 = (c_1 + tmpvar_22);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lm_1 = tmpvar_11;
  c_3.w = tmpvar_4.w;
  c_3.xyz = (tmpvar_4.xyz * min (lm_1, vec3((tmpvar_6 * 2.0))));
  gl_FragData[0] = c_3;
}
