...
uniform mediump sampler2D _Illum;
...
void main()
{
    ...
    u_xlat16_1.x = texture(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat16_1.xxx + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.x = texture(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat16_3.xxx + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_8.xyz * _Color.xyz;
...
void main()
{
    ...
    u_xlat16_1.x = texture(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat16_0.xyz = u_xlat16_4.xyz * u_xlat16_1.xxx + u_xlat16_2.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_3.xyz * u_xlat16_0.xxx + u_xlat16_4.xyz;
    u_xlat16_1.x = texture(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat16_1.xxx + u_xlat16_0.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
    u_xlat13 = vs_TEXCOORD4;
#ifdef UNITY_ADRENO_ES3
    u_xlat13 = min(max(u_xlat13, 0.0), 1.0);
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz;
    u_xlat16_4.x = texture(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_4.xxx + u_xlat16_2.xyz;
    SV_Target3.xyz = exp2((-u_xlat16_1.xyz));
    SV_Target3.w = 1.0;
    return;
}
