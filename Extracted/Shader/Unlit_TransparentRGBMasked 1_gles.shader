...
//
///////////////////////////////////////////
Shader "Unlit/TransparentRGBMasked 1" {
Properties {
...
void main ()
{
  ...
  mediump vec4 col_2;
  highp vec2 tmpvar_3;
  tmpvar_3 = ((vec2(1.0, 1.0) - abs(xlv_TEXCOORD2)) * _ClipArgs0);
  lowp vec4 tmpvar_4;
  tmpvar_4 = (texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR);
  col_2 = tmpvar_4;
  highp float tmpvar_5;
  tmpvar_5 = clamp (min (tmpvar_3.x, tmpvar_3.y), 0.0, 1.0);
  col_2.w = (col_2.w * tmpvar_5);
  lowp float tmpvar_6;
  tmpvar_6 = dot (texture2D (_Mask, xlv_TEXCOORD1).xyz, vec3(0.5, 0.7, 0.3));
