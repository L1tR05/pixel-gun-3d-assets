...
void main()
{
    u_xlat16_0.xyz = texture(_Detail, vs_TEXCOORD0.xy).xyz;
    u_xlat16_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz * u_xlat16_0.xyz + (-u_xlat16_1.xyz);
    u_xlat0.xyz = vec3(_Power) * u_xlat16_0.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_Detail, vs_TEXCOORD0.xy).xyz;
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_Detail, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat16_0.xyz + (-u_xlat16_2.xyz);
    u_xlat0.xyz = vec3(_Power) * u_xlat16_0.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_Detail, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_4.xyz * u_xlat16_3.xyz + (-u_xlat16_4.xyz);
    u_xlat3.xyz = vec3(_Power) * u_xlat16_3.xyz + u_xlat16_4.xyz;
