...
//
///////////////////////////////////////////
Shader "Mobile/Legacy/Lightmap/Lightmap Only" {
Properties {
...
void main()
{
    u_xlat10_0 = texture2D(_LightMap, vs_TEXCOORD0.xy);
...
void main()
{
    ...
    u_xlat16_0 = u_xlat10_0 * _Color;
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD1.xy);
    u_xlat16_2.xyz = u_xlat10_1.xyz * u_xlat16_0.xyz + (-unity_FogColor.xyz);
    u_xlat16_11 = u_xlat16_0.w * u_xlat10_1.w;
