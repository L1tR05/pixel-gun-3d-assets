...
void main()
{
    ...
    u_xlat10_0 = texture(_Texture, u_xlat16_8.xy).x;
...
#endif
    u_xlat16_3.xyz = (-unity_FogColor.xyz) + _Color.xyz;
...
void main()
{
    u_xlat16_0.xyz = _Color.xyz * vec3(0.305306017, 0.305306017, 0.305306017) + vec3(0.682171106, 0.682171106, 0.682171106);
    u_xlat16_0.xyz = _Color.xyz * u_xlat16_0.xyz + vec3(0.0125228781, 0.0125228781, 0.0125228781);
    ...
    u_xlatb6 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(unity_UseLinearSpace);
#endif
    u_xlat16_0.xyz = (bool(u_xlatb6)) ? _Color.xyz : u_xlat0.xyz;
    u_xlat1 = min(unity_MaxOutputValue, 0.0);
    u_xlat16_1.xyz = (unity_MetaFragmentControl.x) ? vec3(u_xlat1) : vec3(0.0, 0.0, 0.0);
