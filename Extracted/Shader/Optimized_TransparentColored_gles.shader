...
void main ()
{
  ...
  lowp vec4 tmpvar_6;
  tmpvar_6 = (texture2D (_MainTex, tmpvar_4) * _Color);
  lowp float x_7;
...
void main ()
{
  ...
  lowp vec4 tmpvar_7;
  tmpvar_7 = (texture2D (_MainTex, tmpvar_5) * _Color);
  lowp float x_8;
  ...
  tmpvar_10 = clamp (dot (texture2D (unity_ShadowMask, xlv_TEXCOORD4), unity_OcclusionMaskSelector), 0.0, 1.0);
  ...
  tmpvar_16 = max (0.0, dot (tmpvar_3, lightDir_12));
  diff_15 = tmpvar_16;
  c_14.xyz = ((tmpvar_7.xyz * _LightColor0.xyz) * ((diff_15 * atten_13) * 1.2));
  c_14.w = tmpvar_7.w;
  tmpvar_11 = c_14;
  c_1 = (c_1 + tmpvar_11);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_26 = max (0.0, dot (tmpvar_3, lightDir_22));
  diff_25 = tmpvar_26;
  c_24.xyz = ((tmpvar_7.xyz * _LightColor0.xyz) * ((diff_25 * atten_23) * 1.2));
  c_24.w = tmpvar_7.w;
  tmpvar_21 = c_24;
  c_1 = (c_1 + tmpvar_21);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  shadowMaskAttenuation_10 = tmpvar_15;
  ...
  tmpvar_17 = tmpvar_21;
  realtimeShadowAttenuation_9 = tmpvar_17;
  mediump float tmpvar_22;
  tmpvar_22 = mix (realtimeShadowAttenuation_9, shadowMaskAttenuation_10, tmpvar_13);
  atten_2 = tmpvar_22;
  c_1.w = 0.0;
  c_1.xyz = (tmpvar_7.xyz * xlv_TEXCOORD3);
  highp vec4 tmpvar_23;
  highp vec3 lightDir_24;
  ...
  tmpvar_28 = max (0.0, dot (tmpvar_3, lightDir_24));
  diff_27 = tmpvar_28;
  c_26.xyz = ((tmpvar_7.xyz * _LightColor0.xyz) * ((diff_27 * atten_25) * 1.2));
  c_26.w = tmpvar_7.w;
  tmpvar_23 = c_26;
  c_1 = (c_1 + tmpvar_23);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  realtimeShadowAttenuation_9 = tmpvar_17;
  mediump float tmpvar_22;
  tmpvar_22 = min (clamp ((realtimeShadowAttenuation_9 + tmpvar_13), 0.0, 1.0), shadowMaskAttenuation_10);
  atten_2 = tmpvar_22;
  c_1.w = 0.0;
  c_1.xyz = (tmpvar_7.xyz * xlv_TEXCOORD3);
  highp vec4 tmpvar_23;
...
void main ()
{
  ...
  lm_1 = tmpvar_12;
  c_3.w = tmpvar_5.w;
  c_3.xyz = (tmpvar_5.xyz * min (lm_1, vec3((tmpvar_7 * 2.0))));
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  lowp vec3 tmpvar_4;
  lowp vec4 tmpvar_5;
  tmpvar_5 = (texture2D (_MainTex, tmpvar_3) * _Color);
