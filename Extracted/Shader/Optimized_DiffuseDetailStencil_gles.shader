...
//
///////////////////////////////////////////
Shader "Optimized/DiffuseDetailStencil" {
Properties {
...
void main()
{
    u_xlat10_0.xyz = texture2D(_Detail, vs_TEXCOORD0.xy).xyz;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_1.xyz * u_xlat10_0.xyz + (-u_xlat10_1.xyz);
    u_xlat0.xyz = vec3(_Power) * u_xlat16_0.xyz + u_xlat10_1.xyz;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture2D(_Detail, vs_TEXCOORD0.xy).xyz;
    u_xlat10_2.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_2.xyz * u_xlat10_0.xyz + (-u_xlat10_2.xyz);
    u_xlat0.xyz = vec3(_Power) * u_xlat16_0.xyz + u_xlat10_2.xyz;
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_Detail, vs_TEXCOORD0.xy).xyz;
    u_xlat10_4.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat10_4.xyz * u_xlat10_3.xyz + (-u_xlat10_4.xyz);
    u_xlat3.xyz = vec3(_Power) * u_xlat16_3.xyz + u_xlat10_4.xyz;
