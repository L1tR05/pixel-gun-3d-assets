...
void main()
{
    ...
    vs_TEXCOORD0.xy = in_TEXCOORD1.xy * _LightMap_ST.xy + _LightMap_ST.zw;
...
void main()
{
    u_xlat16_0 = texture(_LightMap, vs_TEXCOORD0.xy);
...
void main()
{
    u_xlat16_0 = texture(_LightMap, vs_TEXCOORD0.xy);
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD1.xy);
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_0.xyz + (-unity_FogColor.xyz);
    u_xlat16_11 = u_xlat16_0.w * u_xlat16_1.w;
...
void main()
{
    ...
    vs_TEXCOORD1.xy = in_TEXCOORD0.xy * _Reflect_ST.xy + _Reflect_ST.zw;
    u_xlat0 = in_POSITION0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
    u_xlat0 = hlslcc_mtx4x4unity_ObjectToWorld[0] * in_POSITION0.xxxx + u_xlat0;
    u_xlat0 = hlslcc_mtx4x4unity_ObjectToWorld[2] * in_POSITION0.zzzz + u_xlat0;
    u_xlat0 = u_xlat0 + hlslcc_mtx4x4unity_ObjectToWorld[3];
...
precision highp int;
uniform mediump sampler2D _MainTex;
uniform mediump sampler2D _Reflect;
in highp vec2 vs_TEXCOORD0;
in highp vec2 vs_TEXCOORD1;
layout(location = 0) out mediump vec4 SV_Target0;
vec4 u_xlat0;
void main()
{
    u_xlat0.xyz = texture(_Reflect, vs_TEXCOORD1.xy).xyz;
...
void main()
{
    u_xlat16_0.xyz = texture(_Reflect, vs_TEXCOORD1.xy).xyz;
