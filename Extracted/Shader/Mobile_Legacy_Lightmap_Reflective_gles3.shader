...
void main()
{
    u_xlat10_0 = texture(_LightMap, vs_TEXCOORD0.xy);
    u_xlat10_1 = texture(_MainTex, vs_TEXCOORD1.xy);
    u_xlat16_2.xyz = u_xlat10_1.xyz * u_xlat10_0.xyz + (-unity_FogColor.xyz);
    u_xlat16_11 = u_xlat10_0.w * u_xlat10_1.w;
...
precision highp int;
uniform lowp sampler2D _MainTex;
uniform lowp sampler2D _Reflect;
in highp vec2 vs_TEXCOORD0;
in highp vec2 vs_TEXCOORD1;
layout(location = 0) out mediump vec4 SV_Target0;
vec4 u_xlat0;
...
void main()
{
    u_xlat10_0.xyz = texture(_Reflect, vs_TEXCOORD1.xy).xyz;
