...
//
///////////////////////////////////////////
Shader "Optimized/Gloss/Transparent2Sided" {
Properties {
...
uniform highp vec4 _GlossTex_ST;
...
void main ()
{
  ...
  tmpvar_1.zw = ((_glesMultiTexCoord0.xy * _GlossTex_ST.xy) + _GlossTex_ST.zw);
  highp mat3 tmpvar_3;
...
void main ()
{
  ...
  lowp vec4 tmpvar_8;
  tmpvar_8 = texture2D (_MainTex, tmpvar_5);
  tmpvar_2 = (((tmpvar_8.xyz * texture2D (_GlossTex, tmpvar_6).xyz) * 2.0) + tmpvar_8.xyz);
  lowp float x_9;
  ...
  tmpvar_14 = max (0.0, dot (tmpvar_3, lightDir_11));
  diff_13 = tmpvar_14;
  c_12.xyz = ((tmpvar_2 * _LightColor0.xyz) * (diff_13 * 1.2));
  c_12.w = tmpvar_8.w;
  tmpvar_10 = c_12;
  c_1 = (c_1 + tmpvar_10);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_2.zw = ((_glesMultiTexCoord0.xy * _GlossTex_ST.xy) + _GlossTex_ST.zw);
  highp mat3 tmpvar_5;
...
void main ()
{
  ...
  c_3.w = tmpvar_6.w;
  c_3.xyz = (((
    (tmpvar_6.xyz * texture2D (_GlossTex, tmpvar_5).xyz)
   * 2.0) + tmpvar_6.xyz) * lm_1);
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  tmpvar_5 = (((tmpvar_6.xyz * texture2D (_GlossTex, tmpvar_4).xyz) * 2.0) + tmpvar_6.xyz);
  lowp float x_7;
  x_7 = (tmpvar_6.w - _CutOff);
  if ((x_7 < 0.0)) {
    discard;
