...
void main()
{
    ...
    u_xlat16_3.xy = vec2(vs_TEXCOORD0.z + vs_TEXCOORD2.x, vs_TEXCOORD0.w + vs_TEXCOORD2.z);
    u_xlat1.xy = u_xlat16_3.xy / vec2(vec2(_Scale, _Scale));
    ...
    u_xlat2.xyz = u_xlat16_0.xyz * vec3(_Shadow);
    u_xlat1.xyz = u_xlat16_1.xyz * vs_TEXCOORD3.xyz + u_xlat2.xyz;
...
void main()
{
    u_xlat16_0.xy = vec2(vs_TEXCOORD0.z + vs_TEXCOORD2.x, vs_TEXCOORD0.w + vs_TEXCOORD2.z);
    u_xlat1.xy = u_xlat16_0.xy / vec2(vec2(_Scale, _Scale));
    u_xlat10_1.xyz = texture(_MainTex2, u_xlat1.xy).xyz;
    u_xlat10_2.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_1.xyz = u_xlat10_1.xyz * u_xlat10_2.xyz;
    u_xlat16_2.xyz = texture(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz * unity_Lightmap_HDR.xxx;
...
void main()
{
    ...
    u_xlat16_2.xy = vec2(vs_TEXCOORD0.z + vs_TEXCOORD2.x, vs_TEXCOORD0.w + vs_TEXCOORD2.z);
    u_xlat0.xy = u_xlat16_2.xy / vec2(vec2(_Scale, _Scale));
...
#endif
    u_xlat1.xyz = vec3(u_xlat10) * u_xlat1.xyz + unity_FogColor.xyz;
    SV_Target0.xyz = u_xlat1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    u_xlat16_0.xy = vec2(vs_TEXCOORD0.z + vs_TEXCOORD1.x, vs_TEXCOORD0.w + vs_TEXCOORD1.z);
    u_xlat1.xy = u_xlat16_0.xy / vec2(vec2(_Scale, _Scale));
    u_xlat10_1.xyz = texture(_MainTex2, u_xlat1.xy).xyz;
    u_xlat10_2.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_1.xyz = u_xlat10_1.xyz * u_xlat10_2.xyz;
    ...
    u_xlat10 = clamp(u_xlat10, 0.0, 1.0);
#endif
    u_xlat1.xyz = u_xlat16_1.xyz * vec3(u_xlat10);
