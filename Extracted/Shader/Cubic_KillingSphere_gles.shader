...
void main()
{
    ...
    u_xlat10_2 = texture2D(_MainTex2, vs_TEXCOORD1.xy).w;
    u_xlat10_4 = texture2D(_MainTex2, vs_TEXCOORD2.xy).w;
    u_xlat16_1 = u_xlat10_2 * u_xlat10_4 + u_xlat10_0;
    SV_Target0.xyz = vec3(u_xlat10_2) * vec3(u_xlat10_4) + _Color.xyz;
