...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * vec3(0.400000006, 0.400000006, 0.400000006) + u_xlat16_0.xyz;
    return;
}
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_3.xyz * vec3(0.400000006, 0.400000006, 0.400000006) + u_xlat16_0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_Cube, vs_TEXCOORD1.xyz).xyz;
    u_xlat16_0.xyz = u_xlat16_3.xyz * vec3(0.400000006, 0.400000006, 0.400000006) + u_xlat16_0.xyz;
