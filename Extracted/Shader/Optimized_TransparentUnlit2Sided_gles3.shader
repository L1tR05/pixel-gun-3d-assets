...
//
///////////////////////////////////////////
Shader "Optimized/TransparentUnlit2Sided" {
Properties {
_MainTex ("Albedo (RGB)", 2D) = "white" { }
_EmmissionPower ("EmmissionPower", Range(0, 1)) = 0
}
SubShader {
 LOD 200
...
precision highp int;
uniform 	mediump float _EmmissionPower;
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat10_0.w + (-alpha);
    ...
    u_xlat16_1.xyz = u_xlat10_0.xyz * vec3(0.899999976, 0.899999976, 0.899999976);
    u_xlat16_2.xyz = u_xlat10_0.xyz * vs_TEXCOORD3.xyz + u_xlat16_1.xyz;
    SV_Target0.xyz = u_xlat10_0.xyz * vec3(_EmmissionPower) + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_0.xyz * vec3(_EmmissionPower);
...
#endif
    if((int(u_xlatb2) * int(0xffffffffu))!=0){discard;}
    u_xlat16_1.xyz = u_xlat0.xyz * vec3(0.899999976, 0.899999976, 0.899999976);
    u_xlat2.xyz = u_xlat0.xyz * vs_TEXCOORD3.xyz + u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat0.xyz * vec3(_EmmissionPower) + u_xlat2.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    u_xlat16_1.xyz = u_xlat16_2.xyz * unity_Lightmap_HDR.xxx;
    u_xlat16_3.xyz = u_xlat0.xyz * vec3(_EmmissionPower);
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat10_0.xyz * vec3(_EmmissionPower);
...
#ifdef UNITY_ADRENO_ES3
    u_xlatb11 = !!(vec4(0.0, 0.0, 0.0, 0.0)!=vec4(unity_UseLinearSpace));
#else
    u_xlatb11 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(unity_UseLinearSpace);
#endif
    u_xlat16_1.xyz = (bool(u_xlatb11)) ? u_xlat16_1.xyz : u_xlat2.xyz;
