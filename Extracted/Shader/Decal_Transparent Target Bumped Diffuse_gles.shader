...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_7.xyz * u_xlat16_2.xxx + (-unity_FogColor.xyz);
    u_xlat16 = vs_TEXCOORD3.y;
    u_xlat16 = clamp(u_xlat16, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat16) * u_xlat16_1.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat0 = u_xlat10_0 * _Color;
    u_xlat16_7.xyz = u_xlat0.xyz * _LightColor0.xyz;
    u_xlat16_4.xyz = u_xlat0.xyz * vs_TEXCOORD4.xyz;
...
void main()
{
    ...
    u_xlat16_0.x = dot(u_xlat16_4.xyz, u_xlat16_4.xyz);
    u_xlat16_0.x = inversesqrt(u_xlat16_0.x);
    u_xlat0 = u_xlat16_0.xxxx * u_xlat16_4.xyzz;
    u_xlat16_2.x = u_xlat0.y * u_xlat0.y;
    u_xlat16_2.x = u_xlat0.x * u_xlat0.x + (-u_xlat16_2.x);
    ...
    u_xlat10_0 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat0 = u_xlat10_0 * _Color;
    u_xlat3.xyz = u_xlat0.xyz * u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat18 = vs_TEXCOORD3.y;
    u_xlat18 = clamp(u_xlat18, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat18) * u_xlat3.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.x = dot(u_xlat16_0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_1.x = max(u_xlat16_1.x, 0.0);
    u_xlat0 = texture2D(_LightTexture0, vs_TEXCOORD5.xy).w;
...
void main()
{
    ...
    u_xlat3.x = vs_TEXCOORD6;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat3.xxx;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_1.xxx * u_xlat16_5.xyz;
    u_xlat3 = vs_TEXCOORD6;
    u_xlat3 = clamp(u_xlat3, 0.0, 1.0);
    u_xlat0.xyz = u_xlat16_1.xyz * vec3(u_xlat3);
    SV_Target0 = u_xlat0;
    return;
}
