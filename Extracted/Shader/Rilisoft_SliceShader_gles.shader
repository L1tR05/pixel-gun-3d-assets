...
void main ()
{
  ...
  lowp vec3 tmpvar_3;
  if ((((
    (xlv_TEXCOORD2.x < _ClipRange.x)
   || 
    (xlv_TEXCOORD2.y < _ClipRange.y)
  ) || (xlv_TEXCOORD2.x > _ClipRange.z)) || (xlv_TEXCOORD2.y > _ClipRange.w))) {
    discard;
  };
...
void main ()
{
  ...
  lowp vec3 tmpvar_4;
  if ((((
    (xlv_TEXCOORD1.x < _ClipRange.x)
   || 
    (xlv_TEXCOORD1.y < _ClipRange.y)
  ) || (xlv_TEXCOORD1.x > _ClipRange.z)) || (xlv_TEXCOORD1.y > _ClipRange.w))) {
    discard;
  };
