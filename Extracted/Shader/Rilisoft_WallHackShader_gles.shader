...
void main ()
{
  lowp vec4 c_1;
  c_1.w = 0.0;
  c_1.xyz = (_Color2.xyz * xlv_TEXCOORD2);
  c_1 = (c_1 + _Color2);
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = mix (unity_FogColor.xyz, c_1.xyz, vec3(tmpvar_2));
  gl_FragData[0] = c_1;
}
...
""
 ...
 Pass {
  Name "META"
  LOD 200
  Tags { "LIGHTMODE" = "META" "QUEUE" = "Geometry" "RenderType" = "Transparent" }
  ZTest Greater
  ZWrite Off
  Cull Off
  GpuProgramID 94837
...
void main ()
{
  ...
  diff_8 = tmpvar_9;
  c_7.xyz = (((texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * tmpvar_1) * diff_8);
  c_7.w = _ColorRili.w;
  c_6.w = c_7.w;
  c_6.xyz = c_7.xyz;
  gl_FragData[0] = c_6;
...
void main ()
{
  ...
  tmpvar_3 = (texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz;
  tmpvar_1 = _LightColor0.xyz;
  tmpvar_2 = lightDir_5;
  lowp vec4 c_7;
  lowp vec4 c_8;
  ...
  diff_9 = tmpvar_10;
  c_8.xyz = ((tmpvar_3 * tmpvar_1) * diff_9);
  c_8.w = _ColorRili.w;
  c_7.w = c_8.w;
...
void main ()
{
  ...
  diff_12 = tmpvar_13;
  c_11.xyz = ((tmpvar_3 * tmpvar_1) * diff_12);
  c_11.w = _ColorRili.w;
  c_10.w = c_11.w;
  c_10.xyz = (c_11.xyz + (tmpvar_3 * tmpvar_7));
  gl_FragData[0] = c_10;
}
...
void main ()
{
  ...
  diff_19 = tmpvar_20;
  c_18.xyz = ((tmpvar_3 * tmpvar_1) * diff_19);
  c_18.w = _ColorRili.w;
  c_17.w = c_18.w;
  c_17.xyz = (c_18.xyz + (tmpvar_3 * tmpvar_8));
  gl_FragData[0] = c_17;
}
...
void main ()
{
  ...
  c_5.w = _ColorRili.w;
  c_4.w = c_5.w;
  c_4.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * tmpvar_1);
  gl_FragData[0] = c_4;
}
...
void main ()
{
  ...
  c_13.w = _ColorRili.w;
  c_12.w = c_13.w;
  c_12.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * tmpvar_3);
  gl_FragData[0] = c_12;
}
...
void main ()
{
  ...
  tmpvar_10 = max (0.0, dot (tmpvar_4, tmpvar_2));
  diff_9 = tmpvar_10;
  c_8.xyz = (((texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * tmpvar_1) * diff_9);
  c_8.w = _ColorRili.w;
  c_7.w = c_8.w;
  c_7.xyz = c_8.xyz;
  c_3.w = c_7.w;
...
void main ()
{
  ...
  tmpvar_4 = (texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz;
  tmpvar_1 = _LightColor0.xyz;
  tmpvar_2 = lightDir_6;
  lowp vec4 c_8;
  lowp vec4 c_9;
...
void main ()
{
  ...
  c_12.w = _ColorRili.w;
  c_11.w = c_12.w;
  c_11.xyz = (c_12.xyz + (tmpvar_4 * tmpvar_8));
  c_3.w = c_11.w;
...
void main ()
{
  ...
  diff_20 = tmpvar_21;
  c_19.xyz = ((tmpvar_4 * tmpvar_1) * diff_20);
  c_19.w = _ColorRili.w;
  c_18.w = c_19.w;
  c_18.xyz = (c_19.xyz + (tmpvar_4 * tmpvar_9));
  c_3.w = c_18.w;
...
void main ()
{
  ...
  c_6.w = _ColorRili.w;
  c_5.w = c_6.w;
  c_5.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * tmpvar_2);
  c_1.w = c_5.w;
  highp float tmpvar_7;
...
void main ()
{
  ...
  c_14.w = _ColorRili.w;
  c_13.w = c_14.w;
  c_13.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili).xyz * tmpvar_4);
  c_1.w = c_13.w;
  highp float tmpvar_15;
  tmpvar_15 = clamp (xlv_TEXCOORD4, 0.0, 1.0);
