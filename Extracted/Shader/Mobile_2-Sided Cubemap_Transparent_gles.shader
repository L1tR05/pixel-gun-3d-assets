...
void main()
{
    u_xlat10_0.xyz = textureCube(_Cube, vs_TEXCOORD1.xyz).xyz;
...
void main()
{
    ...
    u_xlat10_1.xyz = textureCube(_Cube, vs_TEXCOORD1.xyz).xyz;
...
void main()
{
    ...
    u_xlat10_3.xyz = textureCube(_Cube, vs_TEXCOORD1.xyz).xyz;
