...
void main ()
{
  ...
  tmpvar_4.z = _SunZ;
  lowp float tmpvar_5;
  tmpvar_5 = max (0.8, dot (_normal_1, tmpvar_4));
  highp vec4 tmpvar_6;
  tmpvar_6.w = 1.0;
  ...
  xlv_TEXCOORD1 = ((_glesMultiTexCoord0.xy * _GlossTex_ST.xy) + _GlossTex_ST.zw);
...
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = ((texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR1) + texture2D (_GlossTex, xlv_TEXCOORD1));
