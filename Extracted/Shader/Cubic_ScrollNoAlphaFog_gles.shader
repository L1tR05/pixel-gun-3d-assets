...
void main()
{
    ...
    SV_Target0.xyz = u_xlat10_2.xyz * u_xlat0.xyz + u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat10_2.xyz * _Color.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(3.0, 3.0, 3.0);
    u_xlat16_1.xyz = u_xlat10_2.xyz * u_xlat0.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    SV_Target2 = u_xlat1;
    u_xlat16_2.xyz = u_xlat10_0.xyz * _Color.xyz;
    u_xlat16_3.xyz = u_xlat10_0.xyz * vs_TEXCOORD5.xyz;
