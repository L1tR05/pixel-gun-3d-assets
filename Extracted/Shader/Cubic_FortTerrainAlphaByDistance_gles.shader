...
//
///////////////////////////////////////////
Shader "Cubic/FortTerrainAlphaByDistance" {
Properties {
_Color ("Color", Color) = (1,1,1,1)
_MainTex ("Albedo (RGB)", 2D) = "white" { }
_AlphDist ("Dist", Float) = 20
[Toggle(LIGHTMAP_ENABLE)] _Float ("Enable Lightmap", Float) = 1
_Cut ("Clip", Range(0, 0.2)) = 0.2
}
SubShader {
 LOD 200
...
void main()
{
    u_xlat0 = vs_TEXCOORD2.y + (-_WorldSpaceCameraPos.y);
    u_xlat0 = abs(u_xlat0) / _AlphDist;
    u_xlat0 = log2(u_xlat0);
    u_xlat0 = u_xlat0 * 10.0;
    u_xlat0 = exp2(u_xlat0);
    u_xlatb2 = vs_TEXCOORD2.y<10.0;
    u_xlat2 = u_xlatb2 ? 1.0 : float(0.0);
    u_xlat0 = u_xlat2 + u_xlat0;
    u_xlat0 = min(u_xlat0, 1.0);
    u_xlat16_1 = u_xlat0 + (-_Cut);
...
void main()
{
    u_xlat0.x = vs_TEXCOORD2.y + (-_WorldSpaceCameraPos.y);
    u_xlat0.x = abs(u_xlat0.x) / _AlphDist;
    u_xlat0.x = log2(u_xlat0.x);
    u_xlat0.x = u_xlat0.x * 10.0;
    u_xlat0.x = exp2(u_xlat0.x);
    u_xlatb5 = vs_TEXCOORD2.y<10.0;
    u_xlat5 = u_xlatb5 ? 1.0 : float(0.0);
    u_xlat0.x = u_xlat5 + u_xlat0.x;
    u_xlat0.x = min(u_xlat0.x, 1.0);
    u_xlat16_1.x = u_xlat0.x + (-_Cut);
    ...
    u_xlat16_1.xyz = unity_Lightmap_HDR.xxx * u_xlat16_4.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = unity_Lightmap_HDR.xxx * u_xlat16_4.xyz + u_xlat16_3.xyz;
    u_xlat10_3.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    SV_Target0.xyz = u_xlat16_1.xyz * u_xlat10_3.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_4.xyz * vec3(u_xlat16_1) + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat10_4.xyz * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat10_2.xyz * u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat11 = vs_TEXCOORD2.w;
    u_xlat11 = clamp(u_xlat11, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat11) * u_xlat16_2.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat0;
...
void main()
{
    ...
    u_xlat16_1.xyz = unity_Lightmap_HDR.xxx * u_xlat16_5.xyz + u_xlat16_4.xyz;
    u_xlat10_4.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = u_xlat10_4.xyz * u_xlat16_1.xyz + (-unity_FogColor.xyz);
    u_xlat22 = vs_TEXCOORD2.w;
    u_xlat22 = clamp(u_xlat22, 0.0, 1.0);
    u_xlat0.xyz = vec3(u_xlat22) * u_xlat16_4.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat0;
...
void main()
{
    u_xlat0 = vs_TEXCOORD1.y + (-_WorldSpaceCameraPos.y);
    u_xlat0 = abs(u_xlat0) / _AlphDist;
    u_xlat0 = log2(u_xlat0);
    u_xlat0 = u_xlat0 * 10.0;
    u_xlat0 = exp2(u_xlat0);
    u_xlatb2 = vs_TEXCOORD1.y<10.0;
    u_xlat2 = u_xlatb2 ? 1.0 : float(0.0);
    u_xlat0 = u_xlat2 + u_xlat0;
    u_xlat0 = min(u_xlat0, 1.0);
    u_xlat16_1 = u_xlat0 + (-_Cut);
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat2.xyz = u_xlat10_3.xyz * u_xlat2.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat16_1.xyz = log2(u_xlat16_1.xyz);
    u_xlat16_2.xyz = texture2D(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    u_xlat16_1.xyz = unity_Lightmap_HDR.xxx * u_xlat16_2.xyz + (-u_xlat16_1.xyz);
    u_xlat10_2.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat10_2.xyz * u_xlat16_1.xyz + (-unity_FogColor.xyz);
