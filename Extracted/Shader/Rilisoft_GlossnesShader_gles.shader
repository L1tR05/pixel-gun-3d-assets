...
void main()
{
    ...
    u_xlat0.zw = in_TEXCOORD0.xy * _GlossTex_ST.xy + _GlossTex_ST.zw;
...
void main()
{
    u_xlat10_0.xyz = texture2D(_GlossTex, vs_TEXCOORD0.zw).xyz;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.x = u_xlat10_1.z + u_xlat10_1.x;
    u_xlat16_2.x = u_xlat10_1.y + u_xlat16_2.x;
    ...
    u_xlat16_2.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + u_xlat10_1.xyz;
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_GlossTex, vs_TEXCOORD0.zw).xyz;
    u_xlat10_4.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_15 = u_xlat10_4.z + u_xlat10_4.x;
    u_xlat16_15 = u_xlat10_4.y + u_xlat16_15;
    u_xlat16_15 = u_xlat16_15 * 0.333333343;
    u_xlat16_2.xyz = vec3(u_xlat16_15) * u_xlat10_3.xyz;
    u_xlat16_2.xyz = u_xlat10_4.xyz * u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + u_xlat10_4.xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat1.zw = in_TEXCOORD0.xy * _GlossTex_ST.xy + _GlossTex_ST.zw;
...
void main()
{
    ...
    u_xlat3.zw = in_TEXCOORD0.xy * _GlossTex_ST.xy + _GlossTex_ST.zw;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat10_0.xyz * u_xlat16_2.xxx;
    u_xlat16_2.xyz = u_xlat10_1.xyz * u_xlat16_2.xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + u_xlat10_1.xyz;
    SV_Target0.w = 1.0;
...
void main()
{
    ...
    u_xlat2.zw = in_TEXCOORD0.xy * _GlossTex_ST.xy + _GlossTex_ST.zw;
