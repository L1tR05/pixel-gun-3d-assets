...
//
///////////////////////////////////////////
Shader "Optimized/DiffuseColored" {
Properties {
...
void main ()
{
  ...
  tmpvar_10 = max (0.05, dot (tmpvar_3, lightDir_7));
  diff_9 = tmpvar_10;
  c_8.xyz = ((tmpvar_2 * _LightColor0.xyz) * (diff_9 * 1.2));
  tmpvar_6 = c_8;
  c_1.xyz = (c_1 + tmpvar_6).xyz;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_14 = max (0.05, dot (tmpvar_4, lightDir_10));
  diff_13 = tmpvar_14;
  c_12.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((diff_13 * atten_11) * 1.2));
  tmpvar_9 = c_12;
  c_1.xyz = (c_1 + tmpvar_9).xyz;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lm_1 = tmpvar_5;
  c_3.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0).xyz * _Color.xyz) * lm_1);
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  diff_23 = tmpvar_24;
  c_22.xyz = ((tmpvar_6 * _LightColor0.xyz) * ((diff_23 * atten_21) * 1.2));
  tmpvar_19 = c_22;
...
void main ()
{
  ...
  diff_25 = tmpvar_26;
  c_24.xyz = ((tmpvar_6 * _LightColor0.xyz) * ((diff_25 * atten_23) * 1.2));
  tmpvar_21 = c_24;
...
void main ()
{
  ...
  lm_1 = tmpvar_9;
  c_3.xyz = ((texture2D (_MainTex, xlv_TEXCOORD0).xyz * _Color.xyz) * min (lm_1, vec3((tmpvar_4 * 2.0))));
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  c_3.xyz = mix (unity_FogColor.xyz, c_3.xyz, vec3(tmpvar_6));
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  c_3.xyz = mix (unity_FogColor.xyz, c_3.xyz, vec3(tmpvar_10));
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
