...
void main()
{
    u_xlat16_0 = dot(vs_TEXCOORD2.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_0 = max(u_xlat16_0, 0.0);
    u_xlat16_1.xyz = texture(_Cube, vs_TEXCOORD1.xyz).xyz;
    ...
    u_xlat16_4.xyz = u_xlat16_4.xyz * _ReflectColor.xyz;
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_2.xyz * _ReflectColor.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_Cube, vs_TEXCOORD1.xyz).xyz;
    u_xlat16_2.xyz = u_xlat16_1.www * u_xlat16_3.xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * _ReflectColor.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_Cube, vs_TEXCOORD1.xyz).xyz;
    u_xlat16_2.xyz = u_xlat16_1.www * u_xlat16_1.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz * _ReflectColor.xyz + u_xlat16_0.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
...
void main()
{
    ...
    u_xlat2.xyz = u_xlat0.xyz * (-vec3(u_xlat17)) + (-u_xlat2.xyz);
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_Cube, vs_TEXCOORD1.xyz).xyz;
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_3.xyz = u_xlat16_1.www * u_xlat16_2.xyz;
    u_xlat16_4.xyz = u_xlat16_1.xyz * _Color.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * _ReflectColor.xyz;
    SV_Target0.xyz = u_xlat16_4.xyz * u_xlat0.xyz + u_xlat16_3.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_Cube, vs_TEXCOORD1.xyz).xyz;
    u_xlat16_2 = texture(_MainTex, vs_TEXCOORD0.xy);
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_3.xyz * _ReflectColor.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat3.xyz = u_xlat2.xyz * (-vec3(u_xlat12)) + (-u_xlat3.xyz);
    vs_TEXCOORD2.xyz = u_xlat2.xyz;
    vs_TEXCOORD1.xyz = u_xlat3.xyz;
    vs_TEXCOORD3.xyz = u_xlat0.xyz;
    u_xlat0.xyz = u_xlat0.xyz + (-unity_ShadowFadeCenterAndType.xyz);
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_Cube, vs_TEXCOORD1.xyz).xyz;
    u_xlat16_3.xyz = u_xlat16_0.www * u_xlat16_0.xyz;
    u_xlat16_22 = vs_TEXCOORD2.y * vs_TEXCOORD2.y;
    u_xlat16_22 = vs_TEXCOORD2.x * vs_TEXCOORD2.x + (-u_xlat16_22);
