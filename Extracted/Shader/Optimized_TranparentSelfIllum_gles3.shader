...
void main()
{
    ...
    u_xlat10_3.xyz = texture(_SelfIllum, vs_TEXCOORD0.xy).xyz;
    SV_Target0.xyz = u_xlat10_3.xyz * u_xlat10_0.xyz + u_xlat1.xyz;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture(_SelfIllum, vs_TEXCOORD0.xy).xyz;
...
void main()
{
    ...
    u_xlat1 = u_xlat1 + u_xlat16_2;
    u_xlat10_3.xyz = texture(_SelfIllum, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = u_xlat10_3.xyz * u_xlat10_0.xyz + u_xlat1.xyz;
...
void main()
{
    ...
    u_xlatb9 = vec4(0.0, 0.0, 0.0, 0.0)!=vec4(unity_UseLinearSpace);
#endif
    u_xlat16_1.xyz = (bool(u_xlatb9)) ? u_xlat16_1.xyz : u_xlat2.xyz;
