...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_SelfIllum, vs_TEXCOORD0.xy).xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_SelfIllum, vs_TEXCOORD0.xy).xyz;
...
void main()
{
    ...
    u_xlat1 = u_xlat1 + u_xlat16_2;
    u_xlat16_3.xyz = texture(_SelfIllum, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = u_xlat16_3.xyz * u_xlat16_0.xyz + u_xlat1.xyz;
