...
//
///////////////////////////////////////////
Shader "Optimized/TransparentForInvisibility" {
Properties {
...
void main()
{
    ...
    u_xlat16_0.xyz = vec3(u_xlat4) * _LightColor0.xyz + u_xlat0.xyz;
    u_xlat16_0.w = 1.0;
    vs_COLOR0 = u_xlat16_0 * _ColorRili;
...
void main()
{
    ...
    u_xlatb3 = u_xlat10_0.w<0.200000003;
