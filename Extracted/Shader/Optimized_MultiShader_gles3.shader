...
SubProgram "gles3 hw_tier00 " {
Keywords { "_EMISSION_OFF" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LIGHTING_ENABLE" "_EMISSION_OFF" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LIGHTING_ENABLE" "_EMISSION_OFF" "COLOR_ENABLE" "IS_OPAQUE" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LINEAR" "_EMISSION_OFF" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
#endif
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_3.xyz = u_xlat16_1.xyz * _Color.xyz + (-unity_FogColor.xyz);
    u_xlat16_2 = u_xlat16_1.w * _Color.w;
    SV_Target0.w = u_xlat16_2;
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_3.xyz + unity_FogColor.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    return;
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LINEAR" "LIGHTING_ENABLE" "_EMISSION_OFF" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LINEAR" "LIGHTING_ENABLE" "_EMISSION_OFF" "COLOR_ENABLE" "IS_OPAQUE" }
"#ifdef VERTEX
#version 300 es
...
precision highp int;
uniform mediump sampler2D _MainTex;
uniform mediump sampler2D _SelfIllum;
in highp vec4 vs_TEXCOORD0;
layout(location = 0) out mediump vec4 SV_Target0;
mediump vec3 u_xlat16_0;
mediump vec4 u_xlat16_1;
void main()
{
    u_xlat16_0.xyz = texture(_SelfIllum, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    SV_Target0.xyz = u_xlat16_0.xyz * u_xlat16_1.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_0.xyz * u_xlat16_1.xyz + u_xlat16_2.xyz;
...
SubProgram "gles3 hw_tier00 " {
Keywords { "_EMISSION_TEX" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LIGHTING_ENABLE" "_EMISSION_TEX" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    ...
    u_xlat16_2.xyz = texture(_SelfIllum, vs_TEXCOORD0.zw).xyz;
...
{
    u_xlat16_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_1.xyz = texture(_SelfIllum, vs_TEXCOORD0.zw).xyz;
    SV_Target0.xyz = u_xlat16_1.xyz * u_xlat16_0.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_1.xyz * vs_COLOR0.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LIGHTING_ENABLE" "_EMISSION_TEX" "COLOR_ENABLE" "IS_OPAQUE" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    u_xlat16_0.xyz = texture(_SelfIllum, vs_TEXCOORD0.zw).xyz;
    u_xlat1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2.xyz = u_xlat16_0.xyz * u_xlat1.xyz + u_xlat1.xyz;
...
void main()
{
    ...
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2 = u_xlat16_1 * vs_COLOR0;
    u_xlat16_2.xyz = u_xlat16_0.xyz * u_xlat16_1.xyz + u_xlat16_2.xyz;
    SV_Target0.w = u_xlat16_2.w;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat9 = vs_TEXCOORD1;
#ifdef UNITY_ADRENO_ES3
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LINEAR" "_EMISSION_TEX" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    ...
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_1 = u_xlat16_1 * _Color;
    u_xlat16_2.xyz = u_xlat16_0.xyz * u_xlat16_1.xyz + u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat9 = vs_TEXCOORD1;
#ifdef UNITY_ADRENO_ES3
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LINEAR" "LIGHTING_ENABLE" "_EMISSION_TEX" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    u_xlat16_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_1.xyz = texture(_SelfIllum, vs_TEXCOORD0.zw).xyz;
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_0.xyz + u_xlat16_0.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat9 = vs_TEXCOORD1;
#ifdef UNITY_ADRENO_ES3
    u_xlat9 = min(max(u_xlat9, 0.0), 1.0);
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat16_1.xyz;
    u_xlat16_2.xyz = u_xlat16_1.xyz * vs_COLOR0.xyz + u_xlat16_0.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat9 = vs_TEXCOORD1;
#ifdef UNITY_ADRENO_ES3
    u_xlat9 = min(max(u_xlat9, 0.0), 1.0);
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_0.xyz * _Color.xyz;
    u_xlat16_0.xyz = texture(_SelfIllum, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz * u_xlat16_1.xyz + u_xlat16_1.xyz;
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LINEAR" "LIGHTING_ENABLE" "_EMISSION_TEX" "COLOR_ENABLE" "IS_OPAQUE" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "_EMISSION_ALPHA" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LIGHTING_ENABLE" "_EMISSION_ALPHA" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    u_xlat16_0.x = vs_COLOR0.w;
#ifdef UNITY_ADRENO_ES3
    u_xlatb1 = !!(u_xlat16_0.x<_CutOut);
#else
    u_xlatb1 = u_xlat16_0.x<_CutOut;
#endif
    if(((int(u_xlatb1) * int(0xffffffffu)))!=0){discard;}
    u_xlat16_0 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2.xyz = u_xlat16_0.xyz * u_xlat16_0.www;
...
SubProgram "gles3 hw_tier00 " {
Keywords { "LIGHTING_ENABLE" "_EMISSION_ALPHA" "COLOR_ENABLE" "IS_OPAQUE" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LINEAR" "_EMISSION_ALPHA" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LINEAR" "LIGHTING_ENABLE" "_EMISSION_ALPHA" "COLOR_ENABLE" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    ...
    if(((int(u_xlatb1) * int(0xffffffffu)))!=0){discard;}
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_1.www;
...
SubProgram "gles3 hw_tier00 " {
Keywords { "FOG_LINEAR" "LIGHTING_ENABLE" "_EMISSION_ALPHA" "COLOR_ENABLE" "IS_OPAQUE" }
"#ifdef VERTEX
#version 300 es
