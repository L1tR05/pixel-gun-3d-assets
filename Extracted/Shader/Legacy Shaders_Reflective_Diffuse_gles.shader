...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_1.xyz * u_xlat10_2.www;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat10_1.www * u_xlat10_3.xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * _ReflectColor.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_2 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_3.xyz = u_xlat10_0.xyz * u_xlat10_2.www;
