...
//
///////////////////////////////////////////
Shader "Optimized/Bake/TextureChanger64" {
Properties {
...
void main ()
{
  ...
  lightDir_3 = tmpvar_5;
  tmpvar_4 = xlv_COLOR0.x;
  tmpvar_2 = xlv_TEXCOORD1;
  highp vec2 uv_6;
  highp vec4 vec_7;
  highp int tmpvar_8;
  tmpvar_8 = int((tmpvar_4 * 5.0));
  lowp vec4 tmpvar_9;
  tmpvar_9 = uvs[tmpvar_8];
  vec_7 = tmpvar_9;
  uv_6.x = ((fract(xlv_TEXCOORD0.x) * vec_7.y) + vec_7.x);
  uv_6.y = ((fract(xlv_TEXCOORD0.y) * vec_7.w) + vec_7.z);
  lowp vec4 tmpvar_10;
  tmpvar_10 = texture2D (_MainTex, uv_6);
  c_1.w = 0.0;
  ...
  diff_14 = tmpvar_15;
  c_13.xyz = ((tmpvar_10.xyz * _LightColor0.xyz) * (diff_14 * 2.0));
  c_13.w = tmpvar_10.w;
  tmpvar_11 = c_13;
...
void main ()
{
  ...
  lightDir_4 = tmpvar_6;
  tmpvar_5 = xlv_COLOR0.x;
  tmpvar_3 = xlv_TEXCOORD1;
  highp vec2 uv_7;
  highp vec4 vec_8;
  highp int tmpvar_9;
  tmpvar_9 = int((tmpvar_5 * 5.0));
  lowp vec4 tmpvar_10;
  tmpvar_10 = uvs[tmpvar_9];
  vec_8 = tmpvar_10;
  uv_7.x = ((fract(xlv_TEXCOORD0.x) * vec_8.y) + vec_8.x);
  uv_7.y = ((fract(xlv_TEXCOORD0.y) * vec_8.w) + vec_8.z);
  lowp vec4 tmpvar_11;
  tmpvar_11 = texture2D (_MainTex, uv_7);
  ...
  diff_18 = tmpvar_19;
  c_17.xyz = ((tmpvar_11.xyz * _LightColor0.xyz) * ((diff_18 * atten_16) * 2.0));
  c_17.w = tmpvar_11.w;
  tmpvar_14 = c_17;
...
void main ()
{
  ...
  highp vec4 vec_6;
  highp int tmpvar_7;
  tmpvar_7 = int((tmpvar_4 * 5.0));
  lowp vec4 tmpvar_8;
  tmpvar_8 = uvs[tmpvar_7];
  vec_6 = tmpvar_8;
  uv_5.x = ((fract(xlv_TEXCOORD0.x) * vec_6.y) + vec_6.x);
  uv_5.y = ((fract(xlv_TEXCOORD0.y) * vec_6.w) + vec_6.z);
  ...
  lm_1 = tmpvar_10;
  c_3.xyz = (texture2D (_MainTex, uv_5).xyz * lm_1);
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  diff_28 = tmpvar_29;
  c_27.xyz = ((tmpvar_11.xyz * _LightColor0.xyz) * ((diff_28 * atten_26) * 2.0));
  c_27.w = tmpvar_11.w;
  tmpvar_24 = c_27;
...
void main ()
{
  ...
  diff_30 = tmpvar_31;
  c_29.xyz = ((tmpvar_11.xyz * _LightColor0.xyz) * ((diff_30 * atten_28) * 2.0));
  c_29.w = tmpvar_11.w;
  tmpvar_26 = c_29;
...
void main ()
{
  ...
  lm_1 = tmpvar_14;
  c_3.xyz = (texture2D (_MainTex, uv_5).xyz * min (lm_1, vec3((tmpvar_9 * 2.0))));
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  highp float tmpvar_3;
  tmpvar_3 = xlv_COLOR0.x;
  lowp vec3 tmpvar_4;
  highp vec2 uv_5;
  highp vec4 vec_6;
  highp int tmpvar_7;
  tmpvar_7 = int((tmpvar_3 * 5.0));
  lowp vec4 tmpvar_8;
  tmpvar_8 = uvs[tmpvar_7];
  vec_6 = tmpvar_8;
  uv_5.x = ((fract(xlv_TEXCOORD0.x) * vec_6.y) + vec_6.x);
  uv_5.y = ((fract(xlv_TEXCOORD0.y) * vec_6.w) + vec_6.z);
  tmpvar_4 = texture2D (_MainTex, uv_5).xyz;
  tmpvar_2 = tmpvar_4;
  mediump vec4 res_9;
