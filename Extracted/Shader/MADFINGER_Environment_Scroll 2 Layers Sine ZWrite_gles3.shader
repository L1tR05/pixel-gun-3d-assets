...
//
///////////////////////////////////////////
Shader "MADFINGER/Environment/Scroll 2 Layers Sine ZWrite" {
Properties {
...
void main()
{
    ...
    u_xlat0.xy = vec2(u_xlat1.z + u_xlat0.x, u_xlat1.w + u_xlat0.y);
...
void main()
{
    ...
    u_xlat10_1 = texture(_DetailTex, vs_TEXCOORD0.zw);
