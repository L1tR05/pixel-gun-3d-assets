...
void main ()
{
  ...
  highp vec2 P_6;
  P_6 = ((tmpvar_5.xz + tmpvar_4) / _Scale);
  lowp vec4 tmpvar_7;
  tmpvar_7 = (texture2D (_MainTex, tmpvar_3) * texture2D (_MainTex2, P_6));
  c_1.w = 0.0;
  c_1.xyz = (tmpvar_7.xyz * xlv_TEXCOORD3);
  highp vec4 tmpvar_8;
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_7.xyz * (
    max (0.0, dot (tmpvar_2, vec3(0.0, 2.0, 0.0)))
   - 1.0)) * _Shadow);
  tmpvar_8 = c_9;
...
void main ()
{
  ...
  highp vec2 P_7;
  P_7 = ((tmpvar_6.xz + tmpvar_5) / _Scale);
  ...
  lm_1 = tmpvar_9;
  c_3.xyz = ((texture2D (_MainTex, tmpvar_4) * texture2D (_MainTex2, P_7)).xyz * lm_1);
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  lm_1 = tmpvar_13;
  c_3.xyz = ((texture2D (_MainTex, tmpvar_4) * texture2D (_MainTex2, P_7)).xyz * min (lm_1, vec3((tmpvar_8 * 2.0))));
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  P_7 = ((tmpvar_6.xz + tmpvar_5) / _Scale);
  lowp vec4 tmpvar_8;
  tmpvar_8 = (texture2D (_MainTex, tmpvar_4) * texture2D (_MainTex2, P_7));
...
void main ()
{
  ...
  lm_1 = tmpvar_14;
  c_3.w = tmpvar_8.w;
  c_3.xyz = (tmpvar_8.xyz * min (lm_1, vec3((tmpvar_9 * 2.0))));
...
void main ()
{
  ...
  lowp vec3 tmpvar_6;
  highp vec2 P_7;
  P_7 = ((tmpvar_5.xz + tmpvar_4) / _Scale);
  tmpvar_6 = (texture2D (_MainTex, tmpvar_3) * texture2D (_MainTex2, P_7)).xyz;
  tmpvar_2 = tmpvar_6;
  mediump vec4 res_8;
