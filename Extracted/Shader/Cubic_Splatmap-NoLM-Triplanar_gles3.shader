...
void main()
{
    u_xlat10_0.xyz = texture(_Splat3, vs_TEXCOORD2.xy).xyz;
    ...
    u_xlat10_3.xyz = texture(_Splat2, u_xlat3.xy).xyz;
...
void main()
{
    ...
    u_xlat10_2.xyz = texture(_Splat2, u_xlat1.xy).xyz;
    u_xlat10_3.xyz = texture(_Splat2, u_xlat1.zw).xyz;
    u_xlat16_2.xyz = u_xlat10_2.xyz + (-u_xlat10_3.xyz);
    u_xlat2.xyz = vs_TEXCOORD6.xxx * u_xlat16_2.xyz + u_xlat10_3.xyz;
    u_xlat3.xyz = (-u_xlat2.xyz) + u_xlat10_4.xyz;
    u_xlat2.xyz = vs_TEXCOORD6.yyy * u_xlat3.xyz + u_xlat2.xyz;
