...
SubShader {
 ...
 Pass {
  Name "FORWARD"
  LOD 200
  Tags { "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Geometry+200" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
  GpuProgramID 51071
Program "vp" {
...
void main ()
{
  ...
  tmpvar_7.y = (xlv_TEXCOORD2.y + (_Scroll * 4.0));
  highp vec2 P_8;
  P_8 = (tmpvar_7 / 4.0);
  lowp vec4 tmpvar_9;
  tmpvar_9 = (texture2D (_MainTex, tmpvar_5) * _Color);
  tmpvar_2 = (tmpvar_9.xyz + texture2D (_MainTex3, P_8).xyz);
  lowp float x_10;
  ...
  tmpvar_15 = max (0.05, dot (tmpvar_3, lightDir_12));
  diff_14 = tmpvar_15;
  c_13.xyz = ((tmpvar_2 * _LightColor0.xyz) * (diff_14 * 1.2));
  c_13.w = tmpvar_9.w;
  tmpvar_11 = c_13;
  c_1 = (c_1 + tmpvar_11);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  highp vec2 tmpvar_8;
  tmpvar_8.x = xlv_TEXCOORD2.z;
  tmpvar_8.y = (xlv_TEXCOORD2.y + (_Scroll * 4.0));
  highp vec2 P_9;
  P_9 = (tmpvar_8 / 4.0);
  lowp vec4 tmpvar_10;
  tmpvar_10 = (texture2D (_MainTex, tmpvar_6) * _Color);
  tmpvar_3 = (tmpvar_10.xyz + texture2D (_MainTex3, P_9).xyz);
  lowp float x_11;
  x_11 = (tmpvar_10.w - alpha);
  if ((x_11 < 0.0)) {
    discard;
  };
  ...
  tmpvar_19 = max (0.05, dot (tmpvar_4, lightDir_15));
  diff_18 = tmpvar_19;
  c_17.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((diff_18 * atten_16) * 1.2));
  c_17.w = tmpvar_10.w;
  tmpvar_14 = c_17;
  c_1 = (c_1 + tmpvar_14);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  highp vec2 tmpvar_5;
  tmpvar_5.x = xlv_TEXCOORD2.z;
  tmpvar_5.y = (xlv_TEXCOORD2.y + (_Scroll * 4.0));
  highp vec2 P_6;
  P_6 = (tmpvar_5 / 4.0);
  lowp vec4 tmpvar_7;
  tmpvar_7 = (texture2D (_MainTex, tmpvar_4) * _Color);
  lowp float x_8;
  ...
  lm_1 = tmpvar_10;
  c_3.w = tmpvar_7.w;
  c_3.xyz = ((tmpvar_7.xyz + texture2D (_MainTex3, P_6).xyz) * lm_1);
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  P_9 = (tmpvar_8 / 4.0);
  lowp vec4 tmpvar_10;
  tmpvar_10 = (texture2D (_MainTex, tmpvar_5) * _Color);
  tmpvar_7 = (tmpvar_10.xyz + texture2D (_MainTex3, P_9).xyz);
  lowp float x_11;
  x_11 = (tmpvar_10.w - alpha);
  if ((x_11 < 0.0)) {
    discard;
  ...
  diff_28 = tmpvar_29;
  c_27.xyz = ((tmpvar_7 * _LightColor0.xyz) * ((diff_28 * atten_26) * 1.2));
  c_27.w = tmpvar_10.w;
  tmpvar_24 = c_27;
  c_1 = (c_1 + tmpvar_24);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  diff_30 = tmpvar_31;
  c_29.xyz = ((tmpvar_7 * _LightColor0.xyz) * ((diff_30 * atten_28) * 1.2));
  c_29.w = tmpvar_10.w;
  tmpvar_26 = c_29;
  c_1 = (c_1 + tmpvar_26);
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lm_1 = tmpvar_14;
  c_3.w = tmpvar_7.w;
  c_3.xyz = ((tmpvar_7.xyz + texture2D (_MainTex3, P_6).xyz) * min (lm_1, vec3((tmpvar_9 * 2.0))));
  gl_FragData[0] = c_3;
}
...
""
 ...
 Pass {
  Name "META"
  LOD 200
  Tags { "LIGHTMODE" = "META" "QUEUE" = "Geometry+200" "RenderType" = "Opaque" }
  Cull Off
  GpuProgramID 105847
Program "vp" {
SubProgram "gles hw_tier00 " {
...
void main ()
{
  ...
  lowp vec3 tmpvar_4;
  highp vec2 tmpvar_5;
  tmpvar_5.x = xlv_TEXCOORD1.z;
  tmpvar_5.y = (xlv_TEXCOORD1.y + (_Scroll * 4.0));
  highp vec2 P_6;
  P_6 = (tmpvar_5 / 4.0);
  lowp vec4 tmpvar_7;
  tmpvar_7 = (texture2D (_MainTex, tmpvar_3) * _Color);
  tmpvar_4 = (tmpvar_7.xyz + texture2D (_MainTex3, P_6).xyz);
  lowp float x_8;
  x_8 = (tmpvar_7.w - alpha);
  if ((x_8 < 0.0)) {
    discard;
