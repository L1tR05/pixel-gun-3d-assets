...
uniform mediump sampler2D _GlossTex;
...
void main()
{
    u_xlat16_0.xyz = texture(_GlossTex, vs_TEXCOORD0.zw).xyz;
    u_xlat16_1.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.x = u_xlat16_1.z + u_xlat16_1.x;
    u_xlat16_2.x = u_xlat16_1.y + u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_2.x * 0.333333343;
    u_xlat16_2.xyz = u_xlat16_0.xyz * u_xlat16_2.xxx;
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_3.xyz = texture(_GlossTex, vs_TEXCOORD0.zw).xyz;
    u_xlat16_4.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_15 = u_xlat16_4.z + u_xlat16_4.x;
    u_xlat16_15 = u_xlat16_4.y + u_xlat16_15;
    u_xlat16_15 = u_xlat16_15 * 0.333333343;
    u_xlat16_2.xyz = vec3(u_xlat16_15) * u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_0.xyz * u_xlat16_2.xxx;
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * vec3(2.0, 2.0, 2.0) + u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
