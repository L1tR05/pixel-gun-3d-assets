...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_0.www * _CarColor.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_0.xyz + u_xlat16_0.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_1.www * _CarColor.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_1.xyz + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = max(u_xlat16_3.xyz, vec3(0.00100000005, 0.00100000005, 0.00100000005));
