...
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = (texture2D (_MainTex, xlv_TEXCOORD1) * texture2D (_LightMap, xlv_TEXCOORD0));
...
{
  lowp vec4 col_1;
  col_1 = (texture2D (_MainTex, xlv_TEXCOORD1) * texture2D (_LightMap, xlv_TEXCOORD0));
...
uniform highp mat4 unity_MatrixVP;
uniform highp vec4 _MainTex_ST;
uniform highp vec4 _Reflect_ST;
varying lowp vec4 xlv_COLOR0;
varying highp vec2 xlv_TEXCOORD0;
varying highp vec2 xlv_TEXCOORD1;
void main ()
{
  ...
  xlv_TEXCOORD1 = ((_glesMultiTexCoord0.xy * _Reflect_ST.xy) + _Reflect_ST.zw);
  gl_Position = (unity_MatrixVP * (unity_ObjectToWorld * tmpvar_3));
}
...
void main ()
{
  ...
  col_1.xyz = texture2D (_Reflect, xlv_TEXCOORD1).xyz;
  col_1.w = col_1.w;
  gl_FragData[0] = col_1;
}
...
void main ()
{
  ...
  col_1.w = texture2D (_MainTex, xlv_TEXCOORD0).w;
  lowp vec4 tmpvar_2;
  tmpvar_2 = texture2D (_Reflect, xlv_TEXCOORD1);
