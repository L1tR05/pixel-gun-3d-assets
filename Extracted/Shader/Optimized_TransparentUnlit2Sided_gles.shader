...
uniform lowp float _EmmissionPower;
...
void main ()
{
  ...
  highp vec4 tmpvar_5;
  lowp vec4 c_6;
  c_6.xyz = (tmpvar_3.xyz * 0.9);
  c_6.w = tmpvar_3.w;
  tmpvar_5 = c_6;
  c_1 = (c_1 + tmpvar_5);
  c_1.xyz = (c_1.xyz + (tmpvar_3.xyz * _EmmissionPower));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_3.xyz = (c_3.xyz + (tmpvar_5.xyz * _EmmissionPower));
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  c_1.xyz = mix (unity_FogColor.xyz, c_1.xyz, vec3(tmpvar_7));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_6 = (tmpvar_7.xyz * _EmmissionPower);
  lowp float x_8;
