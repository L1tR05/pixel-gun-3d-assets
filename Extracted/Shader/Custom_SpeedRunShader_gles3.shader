...
void main()
{
    u_xlat10_0 = texture(_MainTex2, vs_TEXCOORD0.zw);
    u_xlat16_0 = u_xlat10_0 * _Color;
    u_xlat0 = u_xlat16_0 * vec4(_Shadow);
    u_xlat16_1.xyz = u_xlat0.www * u_xlat0.xyz;
    u_xlat10_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * _Color2.xyz + u_xlat16_1.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz * _LightColor0.xyz;
    u_xlat9 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat9 = max(u_xlat9, 0.0500000007);
    u_xlat16_1.xyz = vec3(u_xlat9) * u_xlat16_1.xyz;
    u_xlat16_2.xyz = u_xlat16_1.xyz * vec3(1.20000005, 1.20000005, 1.20000005);
    u_xlat16_0.xyz = u_xlat16_0.xyz * vs_TEXCOORD3.xyz + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_0 = u_xlat10_0 * _Color;
    u_xlat0 = u_xlat16_0 * vec4(_Shadow);
    u_xlat16_5.xyz = u_xlat0.www * u_xlat0.xyz;
    u_xlat10_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * _Color2.xyz + u_xlat16_5.xyz;
    u_xlat16_5.xyz = u_xlat16_0.xyz * _LightColor0.xyz;
    u_xlat9 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat9 = max(u_xlat9, 0.0500000007);
    u_xlat16_5.xyz = vec3(u_xlat9) * u_xlat16_5.xyz;
    u_xlat16_1.xyz = vec3(u_xlat16_2) * u_xlat16_5.xyz;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(1.20000005, 1.20000005, 1.20000005);
    u_xlat16_0.xyz = u_xlat16_0.xyz * vs_TEXCOORD3.xyz + u_xlat16_1.xyz;
    SV_Target0.xyz = u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2 = u_xlat0.x * u_xlat16_5.x + u_xlat16_2;
    u_xlat10_0 = texture(_MainTex2, vs_TEXCOORD0.zw);
    u_xlat16_0 = u_xlat10_0 * _Color;
    u_xlat0 = u_xlat16_0 * vec4(_Shadow);
    u_xlat16_5.xyz = u_xlat0.www * u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat16_5.x = dot(u_xlat10_0, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_5.x = min(max(u_xlat16_5.x, 0.0), 1.0);
#else
    u_xlat16_5.x = clamp(u_xlat16_5.x, 0.0, 1.0);
#endif
    u_xlat16_2 = min(u_xlat16_5.x, u_xlat16_2);
    u_xlat10_0 = texture(_MainTex2, vs_TEXCOORD0.zw);
    u_xlat16_0 = u_xlat10_0 * _Color;
    u_xlat0 = u_xlat16_0 * vec4(_Shadow);
    u_xlat16_5.xyz = u_xlat0.www * u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat10_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat10_0.xyz * _Color2.xyz + u_xlat16_2.xyz;
