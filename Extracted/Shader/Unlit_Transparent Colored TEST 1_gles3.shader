...
//
///////////////////////////////////////////
Shader "Unlit/Transparent Colored TEST 1" {
Properties {
_MainTex ("Base (RGB), Alpha (A)", 2D) = "black" { }
_ofstX ("OfstX", Float) = 0
_ofstY ("OfstY", Float) = 0
}
SubShader {
 LOD 200
...
uniform 	float _ofstX;
uniform 	float _ofstY;
...
void main()
{
    u_xlat0.xy = vec2(in_POSITION0.x + float(_ofstX), in_POSITION0.y + float(_ofstY));
    u_xlat1 = u_xlat0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
    u_xlat0 = hlslcc_mtx4x4unity_ObjectToWorld[0] * u_xlat0.xxxx + u_xlat1;
    u_xlat1.x = in_POSITION0.z;
