...
void main()
{
    ...
    u_xlat3.x = vs_COLOR0.x * 5.0;
    u_xlati3 = int(u_xlat3.x);
    u_xlat6.xy = fract(vs_TEXCOORD0.xy);
    u_xlat3.xy = u_xlat6.xy * uvs[u_xlati3].yw + uvs[u_xlati3].xz;
    u_xlat10_3.xyz = texture(_MainTex, u_xlat3.xy).xyz;
    u_xlat16_1.xyz = u_xlat10_3.xyz * _LightColor0.xyz;
    u_xlat2.xyz = u_xlat0.xxx * u_xlat16_1.xyz;
    u_xlat0.xyz = u_xlat10_3.xyz * vs_TEXCOORD3.xyz + u_xlat2.xyz;
...
void main()
{
    ...
    u_xlat0.x = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat0.x = max(u_xlat0.x, 0.0500000007);
    u_xlat0.x = dot(u_xlat0.xx, u_xlat16_1.xx);
    u_xlat3.x = vs_COLOR0.x * 5.0;
    u_xlati3 = int(u_xlat3.x);
    u_xlat6.xy = fract(vs_TEXCOORD0.xy);
    u_xlat3.xy = u_xlat6.xy * uvs[u_xlati3].yw + uvs[u_xlati3].xz;
...
void main()
{
    u_xlat0.x = vs_COLOR0.x * 5.0;
    u_xlati0 = int(u_xlat0.x);
    u_xlat3.xy = fract(vs_TEXCOORD0.xy);
    u_xlat0.xy = u_xlat3.xy * uvs[u_xlati0].yw + uvs[u_xlati0].xz;
    ...
    SV_Target0.xyz = u_xlat10_0.xyz * u_xlat16_2.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat10_3.xyz * vs_TEXCOORD3.xyz + u_xlat1.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat0.xy = u_xlat2.xy * uvs[u_xlati0].yw + uvs[u_xlati0].xz;
    u_xlat10_0.xyz = texture(_MainTex, u_xlat0.xy).xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = texture(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_1.xyz * unity_Lightmap_HDR.xxx;
    u_xlat16_0.xyz = u_xlat10_0.xyz * u_xlat16_2.xyz + (-unity_FogColor.xyz);
    u_xlat9 = vs_TEXCOORD5;
#ifdef UNITY_ADRENO_ES3
    u_xlat9 = min(max(u_xlat9, 0.0), 1.0);
#else
...
void main()
{
    ...
    u_xlat0.xy = u_xlat1.xy * uvs[u_xlati0].yw + uvs[u_xlati0].xz;
    u_xlat10_0.xyz = texture(_MainTex, u_xlat0.xy).xyz;
