...
//
///////////////////////////////////////////
Shader "Rilisoft/SliceToWorldPosShaderX" {
Properties {
_MainTex ("Texture", 2D) = "white" { }
_RightBorder ("RightBorder", Float) = 0
_LeftBorder ("LeftBorder", Float) = 0
}
SubShader {
...
uniform 	mediump float _RightBorder;
uniform 	mediump float _LeftBorder;
...
void main()
{
    ...
    u_xlatb0 = !!(_RightBorder<vs_TEXCOORD2.x);
#else
    u_xlatb0 = _RightBorder<vs_TEXCOORD2.x;
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb2 = !!(vs_TEXCOORD2.x<_LeftBorder);
#else
    u_xlatb2 = vs_TEXCOORD2.x<_LeftBorder;
#endif
    u_xlatb0 = u_xlatb2 || u_xlatb0;
    u_xlat16_1 = vs_TEXCOORD2.x + -100.0;
#ifdef UNITY_ADRENO_ES3
...
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb3 = !!(vs_TEXCOORD2.x<_LeftBorder);
#else
    u_xlatb3 = vs_TEXCOORD2.x<_LeftBorder;
#endif
...
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb5 = !!(vs_TEXCOORD2.x<_LeftBorder);
#else
    u_xlatb5 = vs_TEXCOORD2.x<_LeftBorder;
#endif
    u_xlatb0 = u_xlatb5 || u_xlatb0;
    u_xlat16_1.x = vs_TEXCOORD2.x + -100.0;
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_0.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_0.xyz * _LightColor0.xyz;
    u_xlat16_0.xyz = u_xlat16_3.xyz * vec3(u_xlat16_1) + (-unity_FogColor.xyz);
...
{
#ifdef UNITY_ADRENO_ES3
    u_xlatb0 = !!(_RightBorder<vs_TEXCOORD1.x);
#else
    u_xlatb0 = _RightBorder<vs_TEXCOORD1.x;
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb2 = !!(vs_TEXCOORD1.x<_LeftBorder);
#else
    u_xlatb2 = vs_TEXCOORD1.x<_LeftBorder;
#endif
    u_xlatb0 = u_xlatb2 || u_xlatb0;
    u_xlat16_1 = vs_TEXCOORD1.x + -100.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb2 = !!(u_xlat16_1<0.0);
#else
    u_xlatb2 = u_xlat16_1<0.0;
...
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb3 = !!(vs_TEXCOORD1.x<_LeftBorder);
#else
    u_xlatb3 = vs_TEXCOORD1.x<_LeftBorder;
#endif
    u_xlatb0 = u_xlatb3 || u_xlatb0;
    u_xlat16_1.x = vs_TEXCOORD1.x + -100.0;
#ifdef UNITY_ADRENO_ES3
    u_xlatb3 = !!(u_xlat16_1.x<0.0);
#else
    u_xlatb3 = u_xlat16_1.x<0.0;
...
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb4 = !!(vs_TEXCOORD2.x<_LeftBorder);
#else
    u_xlatb4 = vs_TEXCOORD2.x<_LeftBorder;
#endif
...
#endif
#ifdef UNITY_ADRENO_ES3
    u_xlatb6 = !!(vs_TEXCOORD2.x<_LeftBorder);
#else
    u_xlatb6 = vs_TEXCOORD2.x<_LeftBorder;
#endif
