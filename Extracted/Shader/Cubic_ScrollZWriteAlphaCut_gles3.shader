...
void main()
{
    ...
    u_xlat16_1.x = u_xlat16_0.w * _ColorRili.w + (-_CutOut);
    ...
    u_xlat16_1.xyz = u_xlat16_0.xyz * _ColorRili.xyz + _Emission.xyz;
    u_xlat16_0.x = u_xlat16_0.w * _ColorRili.w;
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_0.xyz * _ColorRili.xyz + _Emission.xyz;
    u_xlat16_0.x = u_xlat16_0.w * _ColorRili.w;
    SV_Target0.w = u_xlat16_0.x;
...
void main()
{
    ...
    if(((int(u_xlatb2) * int(0xffffffffu)))!=0){discard;}
    u_xlat16_1.xyz = u_xlat16_0.xyz * _ColorRili.xyz + _Emission.xyz;
    u_xlat0.w = u_xlat16_0.w * _ColorRili.w;
    u_xlat16_1.xyz = u_xlat16_1.xyz * _LightColor0.xyz;
    u_xlat16_10 = dot(vs_TEXCOORD0.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_10 = max(u_xlat16_10, 0.0);
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_0.xyz * _ColorRili.xyz + _Emission.xyz;
    u_xlat16_0.x = u_xlat16_0.w * _ColorRili.w;
    SV_Target0.w = u_xlat16_0.x;
