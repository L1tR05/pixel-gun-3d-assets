...
void main()
{
    ...
    u_xlat10_1.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target0.xyz = u_xlat16_4.xyz * u_xlat10_1.xxx + u_xlat16_2.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_1.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat10_1.xxx + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_3.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat10_3.xxx + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat10_0 = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat10_3.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat10_3.xyz * _Color.xyz;
...
void main()
{
    ...
    u_xlat16_4.xyz = texture2D(unity_Lightmap, vs_TEXCOORD3.xy).xyz;
    u_xlat16_0.xyz = unity_Lightmap_HDR.xxx * u_xlat16_4.xyz + u_xlat16_3.xyz;
    u_xlat10_3 = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat10_8.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat10_8.xyz * _Color.xyz;
...
void main()
{
    ...
    u_xlat16_1.xyz = vec3(u_xlat10_1) * u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _LightColor0.xyz;
    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat16_0.xxx + u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_4.xyz * _LightColor0.xyz;
    u_xlat16_3.xyz = u_xlat16_4.xyz * vs_TEXCOORD3.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_0.xxx + u_xlat16_3.xyz;
    u_xlat10_1.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat16_0.xyz = u_xlat16_4.xyz * u_xlat10_1.xxx + u_xlat16_2.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
    u_xlat13 = vs_TEXCOORD2.w;
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_3.xyz * u_xlat16_0.xxx + u_xlat16_4.xyz;
    u_xlat10_1.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat16_0.xyz = u_xlat16_2.xyz * u_xlat10_1.xxx + u_xlat16_0.xyz;
    u_xlat16_1.xyz = u_xlat16_0.xyz + (-unity_FogColor.xyz);
    u_xlat13 = vs_TEXCOORD2.w;
    u_xlat13 = clamp(u_xlat13, 0.0, 1.0);
    u_xlat1.xyz = vec3(u_xlat13) * u_xlat16_1.xyz + unity_FogColor.xyz;
...
void main()
{
    ...
    u_xlat10_0.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat10_3.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat10_3.xyz * _Color.xyz;
...
void main()
{
    ...
    SV_Target2 = u_xlat0;
    u_xlat10_0.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat16_0.xyz = u_xlat10_0.xxx * u_xlat16_1.xyz;
...
void main()
{
    ...
    u_xlat10_0.x = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat10_0.xxx + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat16_1.xyz * u_xlat16_2.xyz;
    u_xlat10_4 = texture2D(_Illum, vs_TEXCOORD0.zw).w;
    u_xlat16_1.xyz = u_xlat16_1.xyz * vec3(u_xlat10_4) + u_xlat16_2.xyz;
    SV_Target3.xyz = exp2((-u_xlat16_1.xyz));
    SV_Target3.w = 1.0;
    return;
}
