...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat10_3.xyz * _Color.xyz;
...
void main()
{
    ...
    u_xlat16_2.x = u_xlat10_4.x * u_xlat16_2.x + _LightShadowData.x;
    ...
    u_xlat16_2.xyz = u_xlat10_4.xyz * _Color.xyz;
    u_xlat16_3.xyz = u_xlat16_2.xyz * _LightColor0.xyz;
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_3.xyz;
    u_xlat0.xyz = u_xlat16_2.xyz * vs_TEXCOORD3.xyz + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
