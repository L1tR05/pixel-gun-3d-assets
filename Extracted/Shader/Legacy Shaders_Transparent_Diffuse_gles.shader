...
void main ()
{
  ...
  tmpvar_10 = texture2D (_LightTexture0, vec2(dot (lightCoord_4, lightCoord_4))).w;
  atten_3 = tmpvar_10;
  tmpvar_1 = _LightColor0.xyz;
  tmpvar_2 = lightDir_6;
...
void main ()
{
  ...
  tmpvar_11 = texture2D (_LightTexture0, ((lightCoord_4.xy / lightCoord_4.w) + 0.5));
  tmpvar_10 = tmpvar_11.w;
  lowp float tmpvar_12;
  highp vec4 tmpvar_13;
  tmpvar_13 = texture2D (_LightTextureB0, vec2(dot (lightCoord_4.xyz, lightCoord_4.xyz)));
...
void main ()
{
  ...
  lightCoord_4 = (unity_WorldToLight * tmpvar_9).xyz;
  highp float tmpvar_10;
  tmpvar_10 = (texture2D (_LightTextureB0, vec2(dot (lightCoord_4, lightCoord_4))).w * textureCube (_LightTexture0, lightCoord_4).w);
  atten_3 = tmpvar_10;
  tmpvar_1 = _LightColor0.xyz;
  tmpvar_2 = lightDir_6;
  tmpvar_1 = (tmpvar_1 * atten_3);
