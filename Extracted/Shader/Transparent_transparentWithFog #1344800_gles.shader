...
void main()
{
    ...
    u_xlat16_2 = (-unity_FogStart.x) + unity_FogEnd.x;
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat16_2.xyz * vs_TEXCOORD4.xyz;
    u_xlat16_1.w = 0.0;
    u_xlat16_0 = u_xlat10_0 * _Color + u_xlat16_1;
...
void main()
{
    ...
    u_xlat1.x = (-u_xlat1.x) + unity_FogEnd.x;
    u_xlat16_3.x = (-unity_FogStart.x) + unity_FogEnd.x;
...
void main()
{
    ...
    u_xlat2.x = (-u_xlat2.x) + unity_FogEnd.x;
    u_xlat16_4.x = (-unity_FogStart.x) + unity_FogEnd.x;
    u_xlat2.x = u_xlat2.x / u_xlat16_4.x;
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    vs_TEXCOORD3 = u_xlat2.x;
...
void main()
{
    ...
    u_xlatb2 = u_xlat16_1.x<0.0;
    if(((int(u_xlatb2) * -1))!=0){discard;}
    u_xlat2 = texture2D(_ShadowMapTexture, vs_TEXCOORD6.xy).x;
    u_xlatb2 = vs_TEXCOORD6.z<u_xlat2;
    u_xlat2 = u_xlatb2 ? 1.0 : float(0.0);
    u_xlat2 = max(u_xlat2, _LightShadowData.x);
    u_xlat16_1.x = u_xlat2 + u_xlat2;
    u_xlat16_2.xyz = texture2D(unity_Lightmap, vs_TEXCOORD4.xy).xyz;
...
void main()
{
    ...
    u_xlat15 = (-u_xlat15) + unity_FogEnd.x;
    u_xlat16_4 = (-unity_FogStart.x) + unity_FogEnd.x;
    u_xlat15 = u_xlat15 / u_xlat16_4;
    u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
    vs_TEXCOORD3 = u_xlat15;
...
void main()
{
    ...
    u_xlat18 = (-u_xlat18) + unity_FogEnd.x;
    u_xlat16_4.x = (-unity_FogStart.x) + unity_FogEnd.x;
    u_xlat18 = u_xlat18 / u_xlat16_4.x;
    u_xlat18 = clamp(u_xlat18, 0.0, 1.0);
    vs_TEXCOORD3 = u_xlat18;
    u_xlat16_4.x = u_xlat1.y * u_xlat1.y;
    u_xlat16_4.x = u_xlat1.x * u_xlat1.x + (-u_xlat16_4.x);
    u_xlat16_2 = u_xlat1.yzzx * u_xlat1.xyzz;
    u_xlat16_5.x = dot(unity_SHBr, u_xlat16_2);
...
void main()
{
    ...
    u_xlat4.xyz = hlslcc_mtx4x4unity_ObjectToWorld[3].yyy * hlslcc_mtx4x4unity_MatrixV[1].xyz;
    ...
    u_xlat3.xyz = u_xlat4.xyz * in_POSITION0.www + u_xlat3.xyz;
    u_xlat19 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat19 = sqrt(u_xlat19);
    u_xlat19 = (-u_xlat19) + unity_FogEnd.x;
    u_xlat16_5 = (-unity_FogStart.x) + unity_FogEnd.x;
    u_xlat19 = u_xlat19 / u_xlat16_5;
    u_xlat19 = clamp(u_xlat19, 0.0, 1.0);
    vs_TEXCOORD3 = u_xlat19;
...
void main()
{
    ...
    u_xlat23 = (-u_xlat23) + unity_FogEnd.x;
    u_xlat16_5.x = (-unity_FogStart.x) + unity_FogEnd.x;
    u_xlat23 = u_xlat23 / u_xlat16_5.x;
    u_xlat23 = clamp(u_xlat23, 0.0, 1.0);
    vs_TEXCOORD3 = u_xlat23;
