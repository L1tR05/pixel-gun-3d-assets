...
#endif
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _Alpha_ST.xy + _Alpha_ST.zw;
...
uniform mediump sampler2D _Alpha;
...
void main()
{
    u_xlat16_0 = texture(_Alpha, vs_TEXCOORD0.xy).w;
...
void main()
{
    u_xlat16_0 = texture(_Alpha, vs_TEXCOORD0.xy).w;
    SV_Target0.w = u_xlat16_0 * _Color.w;
    u_xlat16_1.xyz = vs_COLOR0.xyz * _Color.xyz + (-unity_FogColor.xyz);
