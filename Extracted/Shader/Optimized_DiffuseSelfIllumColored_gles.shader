...
//
///////////////////////////////////////////
Shader "Optimized/DiffuseSelfIllumColored" {
Properties {
_MainTex ("Base (RGB)", 2D) = "white" { }
_ColorRili ("Color", Color) = (1,1,1,1)
}
SubShader {
 LOD 150
...
void main ()
{
  ...
  lowp vec4 tmpvar_5;
  tmpvar_5 = (texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili);
  c_1.w = 0.0;
  ...
  tmpvar_10 = max (0.05, dot (tmpvar_2, lightDir_7));
  diff_9 = tmpvar_10;
  c_8.xyz = ((tmpvar_5.xyz * _LightColor0.xyz) * (diff_9 * 1.2));
  tmpvar_6 = c_8;
  c_1 = (c_1 + tmpvar_6);
  c_1.xyz = (c_1.xyz + (tmpvar_5.w * tmpvar_5.xyz));
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 tmpvar_6;
  tmpvar_6 = (texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili);
  mediump float shadowMaskAttenuation_7;
  lowp float tmpvar_8;
  tmpvar_8 = clamp (dot (texture2D (unity_ShadowMask, xlv_TEXCOORD4), unity_OcclusionMaskSelector), 0.0, 1.0);
  shadowMaskAttenuation_7 = tmpvar_8;
  atten_2 = shadowMaskAttenuation_7;
  c_1.w = 0.0;
  c_1.xyz = (tmpvar_6.xyz * xlv_TEXCOORD3);
  highp vec4 tmpvar_9;
  highp vec3 lightDir_10;
  lightDir_10 = lightDir_4;
  highp float atten_11;
  atten_11 = atten_2;
  lowp vec4 c_12;
  lowp float diff_13;
  highp float tmpvar_14;
  tmpvar_14 = max (0.05, dot (tmpvar_3, lightDir_10));
  diff_13 = tmpvar_14;
  c_12.xyz = ((tmpvar_6.xyz * _LightColor0.xyz) * ((diff_13 * atten_11) * 1.2));
  tmpvar_9 = c_12;
  c_1 = (c_1 + tmpvar_9);
  c_1.xyz = (c_1.xyz + (tmpvar_6.w * tmpvar_6.xyz));
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 c_3;
  lowp vec4 tmpvar_4;
  tmpvar_4 = (texture2D (_MainTex, xlv_TEXCOORD0) * _ColorRili);
  ...
  c_3.xyz = (c_3.xyz + (tmpvar_4.w * tmpvar_4.xyz));
  c_3.w = 1.0;
  gl_FragData[0] = c_3;
}
...
void main ()
{
  ...
  tmpvar_24 = max (0.05, dot (tmpvar_3, lightDir_20));
  diff_23 = tmpvar_24;
  c_22.xyz = ((tmpvar_6.xyz * _LightColor0.xyz) * ((diff_23 * atten_21) * 1.2));
  tmpvar_19 = c_22;
  c_1 = (c_1 + tmpvar_19);
  c_1.xyz = (c_1.xyz + (tmpvar_6.w * tmpvar_6.xyz));
  c_1.w = 1.0;
...
void main ()
{
  ...
  shadowMaskAttenuation_8 = tmpvar_13;
  ...
  tmpvar_15 = tmpvar_19;
  realtimeShadowAttenuation_7 = tmpvar_15;
  mediump float tmpvar_20;
  tmpvar_20 = mix (realtimeShadowAttenuation_7, shadowMaskAttenuation_8, tmpvar_11);
  atten_2 = tmpvar_20;
  c_1.w = 0.0;
  c_1.xyz = (tmpvar_6.xyz * xlv_TEXCOORD3);
  ...
  highp float atten_23;
  atten_23 = atten_2;
  lowp vec4 c_24;
  lowp float diff_25;
  highp float tmpvar_26;
  tmpvar_26 = max (0.05, dot (tmpvar_3, lightDir_22));
  diff_25 = tmpvar_26;
  c_24.xyz = ((tmpvar_6.xyz * _LightColor0.xyz) * ((diff_25 * atten_23) * 1.2));
  tmpvar_21 = c_24;
  c_1 = (c_1 + tmpvar_21);
  c_1.xyz = (c_1.xyz + (tmpvar_6.w * tmpvar_6.xyz));
  c_1.w = 1.0;
...
void main ()
{
  ...
  realtimeShadowAttenuation_7 = tmpvar_15;
  mediump float tmpvar_20;
  tmpvar_20 = min (clamp ((realtimeShadowAttenuation_7 + tmpvar_11), 0.0, 1.0), shadowMaskAttenuation_8);
  atten_2 = tmpvar_20;
  c_1.w = 0.0;
  c_1.xyz = (tmpvar_6.xyz * xlv_TEXCOORD3);
  highp vec4 tmpvar_21;
...
void main ()
{
  ...
  tmpvar_5 = (tmpvar_6.w * tmpvar_6.xyz);
  tmpvar_2 = tmpvar_4;
  tmpvar_3 = tmpvar_5;
  mediump vec4 res_7;
