...
SubShader {
 ...
 Pass {
  Name "FORWARD"
  LOD 150
  Tags { "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Transparent-10" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
  GpuProgramID 38493
Program "vp" {
...
void main()
{
    ...
    u_xlat16_1.x = u_xlat10_0.w * _ColorRili.w + (-alpha);
    u_xlat16_0 = u_xlat10_0 * _ColorRili;
    ...
    u_xlat2 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat2 = max(u_xlat2, 0.0500000007);
    u_xlat2 = u_xlat2 * 1.20000005;
    u_xlat16_1.xyz = u_xlat16_0.xyz * _LightColor0.xyz;
    u_xlat1.xyz = vec3(u_xlat2) * u_xlat16_1.xyz;
    u_xlat16_2.xyz = u_xlat16_0.xyz * vs_TEXCOORD3.xyz;
    u_xlat1.w = u_xlat16_0.w;
    u_xlat16_2.w = 0.0;
    u_xlat0 = u_xlat1 + u_xlat16_2;
    SV_Target0 = u_xlat0;
    return;
}
...
{
    u_xlat10_0 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_1 = u_xlat10_0.w * _ColorRili.w + (-alpha);
    u_xlat16_0 = u_xlat10_0 * _ColorRili;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat2 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat2 = max(u_xlat2, 0.0500000007);
    u_xlat2 = u_xlat16_3.x * u_xlat2;
    u_xlat2 = u_xlat2 * 1.20000005;
    u_xlat16_3.xyz = u_xlat16_0.xyz * _LightColor0.xyz;
    u_xlat1.xyz = vec3(u_xlat2) * u_xlat16_3.xyz;
    u_xlat16_2.xyz = u_xlat16_0.xyz * vs_TEXCOORD3.xyz;
    u_xlat1.w = u_xlat16_0.w;
    u_xlat16_2.w = 0.0;
    u_xlat0 = u_xlat1 + u_xlat16_2;
...
#endif
    u_xlat2.x = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat2.x = max(u_xlat2.x, 0.0500000007);
...
void main()
{
    ...
    u_xlat16_5 = dot(u_xlat10_3, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
...
void main()
{
    ...
    u_xlat16_5 = dot(u_xlat10_2, unity_OcclusionMaskSelector);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_5 = min(max(u_xlat16_5, 0.0), 1.0);
#else
    u_xlat16_5 = clamp(u_xlat16_5, 0.0, 1.0);
#endif
    u_xlat16_1.x = min(u_xlat16_5, u_xlat16_1.x);
    u_xlat2.x = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat2.x = max(u_xlat2.x, 0.0500000007);
    u_xlat2.x = u_xlat16_1.x * u_xlat2.x;
    u_xlat2.x = u_xlat2.x * 1.20000005;
...
void main()
{
    ...
    u_xlat16_2.w = 0.0;
    u_xlat0 = u_xlat1 + u_xlat16_2;
    u_xlat3.xyz = u_xlat0.xyz + (-unity_FogColor.xyz);
...
#endif
    u_xlat0.xyz = vec3(u_xlat15) * u_xlat3.xyz + unity_FogColor.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.w = 0.0;
    u_xlat0 = u_xlat1 + u_xlat16_2;
    u_xlat4.xyz = u_xlat0.xyz + (-unity_FogColor.xyz);
...
""
 ...
 Pass {
  Name "META"
  LOD 150
  Tags { "LIGHTMODE" = "META" "QUEUE" = "Transparent-10" "RenderType" = "Opaque" }
  Cull Off
  GpuProgramID 104994
Program "vp" {
SubProgram "gles3 hw_tier00 " {
